...
<details><summary><code>client.<a href="/src/Client.ts">manuallyReviewAReadAdmin6Rnp7Bvc2TReadsReadIdReviewPost</a>(readId, { ...params }) -> unknown</code></summary>
<dl>
<dd>
...
**readId:** `string` — The ID of the read to get the HTML for.
...
<details><summary><code>client.dubbing.<a href="/src/api/resources/dubbing/client/Client.ts">getDubbingTranscript</a>(dubbingId, languageCode, { ...params }) -> unknown</code></summary>
<dl>
<dd>
...
```typescript
await client.dubbing.getDubbingTranscript("dubbing_id", "language_code");
```
...
**request:** `ElevenLabs.DubbingGetDubbingTranscriptRequest`
...
<details><summary><code>client.profile.<a href="/src/api/resources/profile/client/Client.ts">get</a>(handle) -> ElevenLabs.ProfilePageResponseModel</code></summary>
<dl>
<dd>
...
<details><summary><code>client.conversationalAi.<a href="/src/api/resources/conversationalAi/client/Client.ts">getAgentKnowledgeBaseDocumentById</a>(agentId, documentationId) -> ElevenLabs.GetKnowledgeBaseReponseModel</code></summary>
<dl>
<dd>
...
<details><summary><code>client.conversationalAi.<a href="/src/api/resources/conversationalAi/client/Client.ts">addToAgentKnowledgeBase</a>(agentId, { ...params }) -> ElevenLabs.AddKnowledgeBaseResponseModel</code></summary>
<dl>
<dd>
...
<details><summary><code>client.readerPublisherProfiles.<a href="/src/api/resources/readerPublisherProfiles/client/Client.ts">getAPublisherProfileById</a>(publisherProfileId) -> ElevenLabs.ReaderPublisherProfileResponseModel</code></summary>
<dl>
<dd>
...
**publisherProfileId:** `string` — The ID of the publisher profile to get
...
<details><summary><code>client.readerPublisherProfiles.<a href="/src/api/resources/readerPublisherProfiles/client/Client.ts">updateAPublisherProfile</a>(publisherProfileId, { ...params }) -> ElevenLabs.ReaderPublisherProfileResponseModel</code></summary>
<dl>
<dd>
...
<details><summary><code>client.readerPublisherProfiles.<a href="/src/api/resources/readerPublisherProfiles/client/Client.ts">getAllPublisherProfilesByTheWorkspace</a>() -> ElevenLabs.GetReaderPublisherProfilesResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.readerPublisherProfiles.<a href="/src/api/resources/readerPublisherProfiles/client/Client.ts">createAnPublisherProfile</a>({ ...params }) -> ElevenLabs.ReaderPublisherProfileResponseModel</code></summary>
<dl>
<dd>
...
<details><summary><code>client.readerPublisherProfiles.<a href="/src/api/resources/readerPublisherProfiles/client/Client.ts">getAPublisherProfileByReadId</a>(readId) -> ElevenLabs.ReaderPublisherProfileResponseModel</code></summary>
<dl>
<dd>
