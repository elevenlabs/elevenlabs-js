...
import { SendUpstreamMessage } from "../../../../serialization/resources/speechEngine/types/SendUpstreamMessage.js";
import type * as ElevenLabs from "../../../index.js";

export declare namespace SpeechEngineSocket {
    export interface Args {
        socket: core.ReconnectingWebSocket;
    }

    export type Response = ElevenLabs.ReceiveUpstreamMessage;
    type EventHandlers = {
        open?: () => void;
...
export class SpeechEngineSocket {
    public readonly socket: core.ReconnectingWebSocket;
    protected readonly eventHandlers: SpeechEngineSocket.EventHandlers = {};
    ...
    private handleMessage: (event: { data: string }) => void = (event) => {
        ...
        const parsedResponse = serializers.SpeechEngineSocketResponse.parse(data, {
    ...
    constructor(args: SpeechEngineSocket.Args) {
     ...
     * ```
     */
    public on<T extends keyof SpeechEngineSocket.EventHandlers>(
        event: T,
        callback: SpeechEngineSocket.EventHandlers[T],
    ): void {
        this.eventHandlers[event] = callback;
    }

    public sendPublish(message: ElevenLabs.SendUpstreamMessage): void {
        this.assertSocketIsOpen();
        const jsonPayload = SendUpstreamMessage.jsonOrThrow(message, {
            unrecognizedObjectKeys: "passthrough",
            allowUnrecognizedUnionMembers: true,
            allowUnrecognizedEnumValues: true,
            omitUndefined: true,
    ...
    public connect(): SpeechEngineSocket {
