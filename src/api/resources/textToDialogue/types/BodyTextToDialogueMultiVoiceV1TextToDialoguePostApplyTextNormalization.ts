...
export const BodyTextToDialogueMultiVoiceV1TextToDialoguePostApplyTextNormalization = {
    Auto: "auto",
    On: "on",
    Off: "off",
} as const;
export type BodyTextToDialogueMultiVoiceV1TextToDialoguePostApplyTextNormalization =
    (typeof BodyTextToDialogueMultiVoiceV1TextToDialoguePostApplyTextNormalization)[keyof typeof BodyTextToDialogueMultiVoiceV1TextToDialoguePostApplyTextNormalization];
