...
export const ConvertSpeechToTextRequestMultichannelOutputStyle = {
    Separate: "separate",
    Combined: "combined",
} as const;
export type ConvertSpeechToTextRequestMultichannelOutputStyle =
    (typeof ConvertSpeechToTextRequestMultichannelOutputStyle)[keyof typeof ConvertSpeechToTextRequestMultichannelOutputStyle];
