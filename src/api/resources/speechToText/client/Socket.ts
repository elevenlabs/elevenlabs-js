...
import { InputAudioChunk } from "../../../../serialization/types/InputAudioChunk.js";
import type * as ElevenLabs from "../../../index.js";

export declare namespace SpeechToTextSocket {
    export interface Args {
        socket: core.ReconnectingWebSocket;
    }

    export type Response = ElevenLabs.ReceiveTranscription;
    type EventHandlers = {
        open?: () => void;
...
export class SpeechToTextSocket {
    ...
    protected readonly eventHandlers: SpeechToTextSocket.EventHandlers = {};
    ...
    private handleMessage: (event: { data: string }) => void = (event) => {
        ...
        const parsedResponse = serializers.SpeechToTextSocketResponse.parse(data, {
    ...
    constructor(args: SpeechToTextSocket.Args) {
     ...
     * ```
     */
    public on<T extends keyof SpeechToTextSocket.EventHandlers>(
        event: T,
        callback: SpeechToTextSocket.EventHandlers[T],
    ): void {
        this.eventHandlers[event] = callback;
    }

    public sendPublish(message: ElevenLabs.InputAudioChunk): void {
        this.assertSocketIsOpen();
        const jsonPayload = InputAudioChunk.jsonOrThrow(message, {
            unrecognizedObjectKeys: "passthrough",
            allowUnrecognizedUnionMembers: true,
            allowUnrecognizedEnumValues: true,
            omitUndefined: true,
    ...
    public connect(): SpeechToTextSocket {
