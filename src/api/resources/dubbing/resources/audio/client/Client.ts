...
export class AudioClient {
    ...
    public get(
        ...
        return core.HttpResponsePromise.fromPromise(this.__get(dubbing_id, language_code, requestOptions));
    }
    ...
    private async __get(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)<ReadableStream<Uint8Array>>({
            url: core.url.join(
                ...
                `v1/dubbing/${core.url.encodePathParam(dubbing_id)}/audio/${core.url.encodePathParam(language_code)}`,
            ),
            method: "GET",
            headers: _headers,
