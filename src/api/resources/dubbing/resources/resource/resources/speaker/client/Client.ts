...
export class Speaker {
    ...
    public async update(
    ...
    ): Promise<ElevenLabs.SpeakerUpdatedResponse> {
        ...
        if (_response.ok) {
            return _response.body as ElevenLabs.SpeakerUpdatedResponse;
        }
    ...
    public async findSimilarVoices(
        ...
        speakerId: string,
        requestOptions?: Speaker.RequestOptions,
    ): Promise<ElevenLabs.SimilarVoicesForSpeakerResponse> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (
        ...
        if (_response.ok) {
            return _response.body as ElevenLabs.SimilarVoicesForSpeakerResponse;
        }
