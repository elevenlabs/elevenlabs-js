...
export class Speaker {
    ...
    private async __update(
        ...
        if (_response.ok) {
            return { data: _response.body as ElevenLabs.SpeakerUpdatedResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __findSimilarVoices(
        ...
        if (_response.ok) {
            return {
                data: _response.body as ElevenLabs.SimilarVoicesForSpeakerResponse,
                rawResponse: _response.rawResponse,
            };
        }
