...
export class SegmentClient {
    ...
    public create(
        ...
        return core.HttpResponsePromise.fromPromise(this.__create(dubbing_id, speaker_id, request, requestOptions));
    }
    ...
    private async __create(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `v1/dubbing/resource/${core.url.encodePathParam(dubbing_id)}/speaker/${core.url.encodePathParam(speaker_id)}/segment`,
            ),
            method: "POST",
            headers: _headers,
