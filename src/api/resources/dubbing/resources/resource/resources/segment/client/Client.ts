...
export class Segment {
    ...
    private async __update(
        ...
        if (_response.ok) {
            return { data: _response.body as ElevenLabs.SegmentUpdateResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __delete(
        ...
        if (_response.ok) {
            return { data: _response.body as ElevenLabs.SegmentDeleteResponse, rawResponse: _response.rawResponse };
        }
