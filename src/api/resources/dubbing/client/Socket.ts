...
import { SendDubbingStreamMessage } from "../../../../serialization/resources/dubbing/types/SendDubbingStreamMessage.js";
import type * as ElevenLabs from "../../../index.js";

export declare namespace DubbingSocket {
    export interface Args {
        socket: core.ReconnectingWebSocket;
    }

    export type Response = ElevenLabs.ReceiveDubbingStreamMessage;
    type EventHandlers = {
        open?: () => void;
...
export class DubbingSocket {
    ...
    protected readonly eventHandlers: DubbingSocket.EventHandlers = {};
    ...
    private handleMessage: (event: { data: string }) => void = (event) => {
        ...
        const parsedResponse = serializers.DubbingSocketResponse.parse(data, {
    ...
    constructor(args: DubbingSocket.Args) {
     ...
     * ```
     */
    public on<T extends keyof DubbingSocket.EventHandlers>(event: T, callback: DubbingSocket.EventHandlers[T]): void {
        this.eventHandlers[event] = callback;
    }

    public sendPublish(message: ElevenLabs.SendDubbingStreamMessage): void {
        this.assertSocketIsOpen();
        const jsonPayload = SendDubbingStreamMessage.jsonOrThrow(message, {
            unrecognizedObjectKeys: "passthrough",
            allowUnrecognizedUnionMembers: true,
            allowUnrecognizedEnumValues: true,
            omitUndefined: true,
