...
export class EnvironmentVariablesClient {
     ...
     *
     * @param {ElevenLabs.ListEnvironmentVariablesRequest} request
    ...
    private async __list(
        ...
        const _queryParams: Record<string, unknown> = {
            ...
            type:
                type_ != null
                    ? serializers.ListEnvironmentVariablesRequestType.jsonOrThrow(type_, {
     ...
     *
     * @param {ElevenLabs.CreateEnvironmentVariablesRequestBody} request
     * @param {EnvironmentVariablesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link ElevenLabs.BadRequestError}
    ...
    private async __create(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.CreateEnvironmentVariablesRequestBody.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
    ...
    private async __update(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.UpdateEnvironmentVariableRequest.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
                requestOptions?.additionalBodyParameters,
