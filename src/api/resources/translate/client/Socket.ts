...
import { SendTranslateStreamMessage } from "../../../../serialization/resources/translate/types/SendTranslateStreamMessage.js";
import type * as ElevenLabs from "../../../index.js";

export declare namespace TranslateSocket {
    export interface Args {
        socket: core.ReconnectingWebSocket;
    }

    export type Response = ElevenLabs.ReceiveTranslateStreamMessage;
    type EventHandlers = {
        open?: () => void;
...
export class TranslateSocket {
    ...
    protected readonly eventHandlers: TranslateSocket.EventHandlers = {};
    ...
    private handleMessage: (event: { data: string }) => void = (event) => {
        ...
        const parsedResponse = serializers.TranslateSocketResponse.parse(data, {
    ...
    constructor(args: TranslateSocket.Args) {
     ...
     * ```
     */
    public on<T extends keyof TranslateSocket.EventHandlers>(
        event: T,
        callback: TranslateSocket.EventHandlers[T],
    ): void {
        this.eventHandlers[event] = callback;
    }

    public sendPublish(message: ElevenLabs.SendTranslateStreamMessage): void {
        this.assertSocketIsOpen();
        const jsonPayload = SendTranslateStreamMessage.jsonOrThrow(message, {
            unrecognizedObjectKeys: "passthrough",
            allowUnrecognizedUnionMembers: true,
            allowUnrecognizedEnumValues: true,
            omitUndefined: true,
    ...
    public connect(): TranslateSocket {
