...
export class Snapshots {
    ...
    private async __list(
        ...
        if (_response.ok) {
            return { data: _response.body as ElevenLabs.ProjectSnapshotsResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __get(
        ...
        if (_response.ok) {
            return {
                data: _response.body as ElevenLabs.ProjectSnapshotExtendedResponseModel,
                rawResponse: _response.rawResponse,
            };
        }
