...
import { ChaptersClient } from "../resources/chapters/client/Client.js";
import { ContentClient } from "../resources/content/client/Client.js";
import { PronunciationDictionariesClient } from "../resources/pronunciationDictionaries/client/Client.js";
...
export class ProjectsClient {
    ...
    private async __create(
        ...
        if (request.qualityPreset != null) {
            _body.append(
                "quality_preset",
                serializers.QualityPresetType.jsonOrThrow(request.qualityPreset, {
        ...
        if (request.targetAudience != null) {
            _body.append(
                "target_audience",
                serializers.studio.CreateProjectsRequestTargetAudience.jsonOrThrow(request.targetAudience, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
            );
        ...
        if (request.fiction != null) {
            _body.append(
                "fiction",
                serializers.studio.CreateProjectsRequestFiction.jsonOrThrow(request.fiction, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
            );
        ...
        if (request.applyTextNormalization != null) {
            _body.append(
                ...
                serializers.studio.CreateProjectsRequestApplyTextNormalization.jsonOrThrow(
        ...
        if (request.sourceType != null) {
            _body.append(
                "source_type",
                serializers.studio.CreateProjectsRequestSourceType.jsonOrThrow(request.sourceType, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
            );
     ...
     * @param {ElevenLabs.studio.GetProjectsRequest} request
     * @param {ProjectsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link ElevenLabs.UnprocessableEntityError}
     * @throws {@link errors.ElevenLabsError}
    ...
    private async __update(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.studio.BodyUpdateStudioProjectV1StudioProjectsProjectIdPost.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
    ...
    public getMutedTracks(
        project_id: string,
        requestOptions?: ProjectsClient.RequestOptions,
    ): core.HttpResponsePromise<ElevenLabs.ProjectMutedTracksResponseModel> {
    ...
    private async __getMutedTracks(
        project_id: string,
        requestOptions?: ProjectsClient.RequestOptions,
    ): Promise<core.WithRawResponse<ElevenLabs.ProjectMutedTracksResponseModel>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "xi-api-key": requestOptions?.apiKey ?? this._options?.apiKey ?? process.env?.ELEVENLABS_API_KEY,
