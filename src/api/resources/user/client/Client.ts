...
import { SubscriptionClient } from "../resources/subscription/client/Client.js";
...
export class UserClient {
    ...
    private async __get(requestOptions?: UserClient.RequestOptions): Promise<core.WithRawResponse<ElevenLabs.User>> {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/user");
    }
}
