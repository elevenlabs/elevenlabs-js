...
export class WhatsappClient {
    ...
    private async __outboundCall(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.conversationalAi.BodyMakeAnOutboundCallViaWhatsAppV1ConvaiWhatsappOutboundCallPost.jsonOrThrow(
                    request,
    ...
    private async __outboundMessage(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.conversationalAi.BodySendAnOutboundMessageViaWhatsAppV1ConvaiWhatsappOutboundMessagePost.jsonOrThrow(
                    request,
                    { unrecognizedObjectKeys: "strip" },
                ),
                requestOptions?.additionalBodyParameters,
