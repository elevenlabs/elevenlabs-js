...
export class AgentsClient {
     ...
     */
    public getDefaultInterruptionIgnoreTerms(
        requestOptions?: AgentsClient.RequestOptions,
    ): core.HttpResponsePromise<ElevenLabs.DefaultInterruptionIgnoreTermsResponseModel> {
        return core.HttpResponsePromise.fromPromise(this.__getDefaultInterruptionIgnoreTerms(requestOptions));
    }

    private async __getDefaultInterruptionIgnoreTerms(
        requestOptions?: AgentsClient.RequestOptions,
    ): Promise<core.WithRawResponse<ElevenLabs.DefaultInterruptionIgnoreTermsResponseModel>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({ "xi-api-key": requestOptions?.apiKey ?? this._options?.apiKey }),
            requestOptions?.headers,
        ...
        if (_response.ok) {
            return {
                data: serializers.DefaultInterruptionIgnoreTermsResponseModel.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    breadcrumbsPrefix: ["response"],
