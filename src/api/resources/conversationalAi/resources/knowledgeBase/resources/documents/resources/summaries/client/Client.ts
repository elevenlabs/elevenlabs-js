...
export class SummariesClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<SummariesClient.Options>;
     ...
     *
     * @param {ElevenLabs.conversationalAi.knowledgeBase.documents.SummariesGetRequest} request
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: serializers.conversationalAi.knowledgeBase.documents.summaries.get.Response.parseOrThrow(
                    _response.body,
                    {
