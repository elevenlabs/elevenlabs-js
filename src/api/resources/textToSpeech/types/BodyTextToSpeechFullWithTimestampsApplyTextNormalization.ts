...
export const BodyTextToSpeechFullWithTimestampsApplyTextNormalization = {
    Auto: "auto",
    On: "on",
    Off: "off",
} as const;
export type BodyTextToSpeechFullWithTimestampsApplyTextNormalization =
    (typeof BodyTextToSpeechFullWithTimestampsApplyTextNormalization)[keyof typeof BodyTextToSpeechFullWithTimestampsApplyTextNormalization];
