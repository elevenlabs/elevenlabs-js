...
export const ConvertTextToSpeechRequestOutputFormat = {
    Alaw8000: "alaw_8000",
...
export type ConvertTextToSpeechRequestOutputFormat =
    (typeof ConvertTextToSpeechRequestOutputFormat)[keyof typeof ConvertTextToSpeechRequestOutputFormat];
