...
export class TextToSpeechSocket {
    public readonly socket: core.ReconnectingWebSocket;
    protected readonly eventHandlers: TextToSpeechSocket.EventHandlers = {};
    ...
    private handleMessage: (event: { data: string }) => void = (event) => {
        ...
        const parsedResponse = serializers.TextToSpeechSocketResponse.parse(data, {
    ...
    constructor(args: TextToSpeechSocket.Args) {
     ...
     * ```
     */
    public on<T extends keyof TextToSpeechSocket.EventHandlers>(
        event: T,
        callback: TextToSpeechSocket.EventHandlers[T],
    ): void {
    ...
    public connect(): TextToSpeechSocket {
