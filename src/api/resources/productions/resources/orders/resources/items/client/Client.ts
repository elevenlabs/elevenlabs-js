    ...
    private async __upsert(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `v1/productions/orders/${core.url.encodePathParam(serializers.OrderId.jsonOrThrow(order_id, { omitUndefined: true }))}/items`,
            ),
            method: "POST",
            headers: _headers,
            ...
            body: mergeAdditionalBodyParameters(
                serializers.productions.orders.BodyUpsertOrderItemV1ProductionsOrdersOrderIdItemsPost.jsonOrThrow(
                    request,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.ElevenLabsEnvironment.Production,
                `v1/productions/orders/${core.url.encodePathParam(serializers.OrderId.jsonOrThrow(order_id, { omitUndefined: true }))}/items/${core.url.encodePathParam(serializers.ItemId.jsonOrThrow(item_id, { omitUndefined: true }))}`,
            ),
            method: "DELETE",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
