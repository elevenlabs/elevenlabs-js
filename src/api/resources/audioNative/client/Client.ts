    ...
    private async __create(
        ...
        if (request.applyTextNormalization != null) {
            _body.append(
                ...
                serializers.CreateAudioNativeRequestApplyTextNormalization.jsonOrThrow(request.applyTextNormalization, {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v1/audio-native");
    }
    ...
    private async __updateContentFromUrl(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.BodyUpdateAudioNativeContentFromUrlV1AudioNativeContentPost.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
