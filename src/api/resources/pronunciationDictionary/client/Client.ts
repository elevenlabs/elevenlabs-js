...
export class PronunciationDictionary {
     ...
     *
     * @example
     *     await elevenLabs.pronunciationDictionary.getPronunciationDictionariesV1PronunciationDictionariesGet()
     */
    public async getPronunciationDictionariesV1PronunciationDictionariesGet(
        request: ElevenLabs.GetPronunciationDictionariesV1PronunciationDictionariesGetRequest = {},
        requestOptions?: PronunciationDictionary.RequestOptions
    ...
    public async getAll(requestOptions?: PronunciationDictionary.RequestOptions): Promise<void> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.ElevenLabsEnvironment.Production,
                "v1/pronunciation-dictionaries"
