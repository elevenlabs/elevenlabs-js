...
export class ApiKeysClient {
    ...
    private async __create(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.serviceAccounts.BodyCreateServiceAccountApiKeyV1ServiceAccountsServiceAccountUserIdApiKeysPost.jsonOrThrow(
                    request,
    ...
    private async __update(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.serviceAccounts.BodyEditServiceAccountApiKeyV1ServiceAccountsServiceAccountUserIdApiKeysApiKeyIdPatch.jsonOrThrow(
                    request,
                    { unrecognizedObjectKeys: "strip", omitUndefined: true },
                ),
                requestOptions?.additionalBodyParameters,
