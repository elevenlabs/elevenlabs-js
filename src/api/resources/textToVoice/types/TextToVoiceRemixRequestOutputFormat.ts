...
export const TextToVoiceRemixRequestOutputFormat = {
...
export type TextToVoiceRemixRequestOutputFormat =
    (typeof TextToVoiceRemixRequestOutputFormat)[keyof typeof TextToVoiceRemixRequestOutputFormat];
