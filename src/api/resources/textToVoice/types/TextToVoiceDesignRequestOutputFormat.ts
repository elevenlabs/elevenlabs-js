...
export const TextToVoiceDesignRequestOutputFormat = {
...
export type TextToVoiceDesignRequestOutputFormat =
    (typeof TextToVoiceDesignRequestOutputFormat)[keyof typeof TextToVoiceDesignRequestOutputFormat];
