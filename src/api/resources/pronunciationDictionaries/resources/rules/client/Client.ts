...
export class RulesClient {
    ...
    private async __set(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `v1/pronunciation-dictionaries/${core.url.encodePathParam(pronunciation_dictionary_id)}/set-rules`,
            ),
            method: "POST",
            headers: _headers,
            ...
            body: mergeAdditionalBodyParameters(
                serializers.pronunciationDictionaries.BodySetRulesOnThePronunciationDictionaryV1PronunciationDictionariesPronunciationDictionaryIdSetRulesPost.jsonOrThrow(
                    request,
    ...
    private async __add(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.pronunciationDictionaries.PronunciationDictionary.jsonOrThrow(request, {
    ...
    private async __remove(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.pronunciationDictionaries.RemovePronunciationDictionaryRulesRequest.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
                requestOptions?.additionalBodyParameters,
