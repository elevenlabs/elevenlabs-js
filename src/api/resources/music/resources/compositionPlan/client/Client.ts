...
export class CompositionPlanClient {
    ...
    ): core.HttpResponsePromise<ElevenLabs.music.CreateCompositionPlanResponse> {
    ...
    private async __create(
        request: ElevenLabs.music.BodyGenerateCompositionPlanV1MusicPlanPost,
        requestOptions?: CompositionPlanClient.RequestOptions,
    ): Promise<core.WithRawResponse<ElevenLabs.music.CreateCompositionPlanResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.music.CreateCompositionPlanResponse.parseOrThrow(_response.body, {
