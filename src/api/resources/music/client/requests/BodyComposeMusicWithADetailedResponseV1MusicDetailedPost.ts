...
export interface BodyComposeMusicWithADetailedResponseV1MusicDetailedPost {
    ...
    outputFormat?: ElevenLabs.ComposeDetailedMusicRequestOutputFormat;
    /** A simple text prompt to generate a song from. Cannot be used in conjunction with `composition_plan`. */
    prompt?: string;
    /** A detailed composition plan to guide music generation. Cannot be used in conjunction with `prompt`. */
    compositionPlan?: ElevenLabs.BodyComposeMusicWithADetailedResponseV1MusicDetailedPostCompositionPlan;
    ...
    modelId?: ElevenLabs.BodyComposeMusicWithADetailedResponseV1MusicDetailedPostModelId;
