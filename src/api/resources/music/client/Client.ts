...
import { CompositionPlanClient } from "../resources/compositionPlan/client/Client.js";
import { FinetunesClient } from "../resources/finetunes/client/Client.js";
...
export class MusicClient {
    ...
    protected _finetunes: FinetunesClient | undefined;
    ...
    public get finetunes(): FinetunesClient {
        return (this._finetunes ??= new FinetunesClient(this._options));
    }
    ...
    private async __compose(
        ...
        const _queryParams: Record<string, unknown> = {
            output_format:
                outputFormat != null
                    ? serializers.ComposeMusicRequestOutputFormat.jsonOrThrow(outputFormat, {
                          unrecognizedObjectKeys: "strip",
                          omitUndefined: true,
                      })
                    : undefined,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)<ReadableStream<Uint8Array>>({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.BodyComposeMusicV1MusicPost.jsonOrThrow(_body, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
    ...
    private async __composeDetailed(
        ...
        const _queryParams: Record<string, unknown> = {
            output_format:
                outputFormat != null
                    ? serializers.ComposeDetailedMusicRequestOutputFormat.jsonOrThrow(outputFormat, {
                          unrecognizedObjectKeys: "strip",
                          omitUndefined: true,
                      })
                    : undefined,
    ...
    private async __composeDetailedStream(
        ...
        const _queryParams: Record<string, unknown> = {
            output_format:
                outputFormat != null
                    ? serializers.ComposeDetailedStreamMusicRequestOutputFormat.jsonOrThrow(outputFormat, {
                          unrecognizedObjectKeys: "strip",
                          omitUndefined: true,
                      })
                    : undefined,
    ...
    private async __stream(
        ...
        const _queryParams: Record<string, unknown> = {
            output_format:
                outputFormat != null
                    ? serializers.StreamMusicRequestOutputFormat.jsonOrThrow(outputFormat, {
                          unrecognizedObjectKeys: "strip",
                          omitUndefined: true,
                      })
                    : undefined,
    ...
    private async __separateStems(
        ...
        if (request.stemVariationId != null) {
            _body.append(
                "stem_variation_id",
                serializers.SeparateStemsMusicRequestStemVariationId.jsonOrThrow(request.stemVariationId, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
            );
