...
export const StreamMusicRequestOutputFormat = {
    Auto: "auto",
...
export type StreamMusicRequestOutputFormat =
    (typeof StreamMusicRequestOutputFormat)[keyof typeof StreamMusicRequestOutputFormat];
