...
export const MusicStreamRequestOutputFormat = {
...
export type MusicStreamRequestOutputFormat =
    (typeof MusicStreamRequestOutputFormat)[keyof typeof MusicStreamRequestOutputFormat];
