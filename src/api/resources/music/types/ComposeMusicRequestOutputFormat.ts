...
export const ComposeMusicRequestOutputFormat = {
    Auto: "auto",
...
export type ComposeMusicRequestOutputFormat =
    (typeof ComposeMusicRequestOutputFormat)[keyof typeof ComposeMusicRequestOutputFormat];
