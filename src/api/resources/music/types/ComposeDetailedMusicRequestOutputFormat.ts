...
export const ComposeDetailedMusicRequestOutputFormat = {
    Auto: "auto",
...
export type ComposeDetailedMusicRequestOutputFormat =
    (typeof ComposeDetailedMusicRequestOutputFormat)[keyof typeof ComposeDetailedMusicRequestOutputFormat];
