...
export const MusicComposeRequestOutputFormat = {
...
export type MusicComposeRequestOutputFormat =
    (typeof MusicComposeRequestOutputFormat)[keyof typeof MusicComposeRequestOutputFormat];
