...
export class HistoryClient {
     ...
     *
     * @param {ElevenLabs.ListHistoryRequest} request
    ...
    private async __list(
        ...
        const _queryParams: Record<string, unknown> = {
            ...
            sort_direction:
                sortDirection != null
                    ? serializers.ListHistoryRequestSortDirection.jsonOrThrow(sortDirection, {
            ...
            source:
                source != null
                    ? serializers.ListHistoryRequestSource.jsonOrThrow(source, {
                          unrecognizedObjectKeys: "strip",
                          omitUndefined: true,
                      })
                    : undefined,
    ...
    private async __download(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)<ReadableStream<Uint8Array>>({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.DownloadHistoryRequest.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
