...
export class AudioClient {
     ...
     * @param {ElevenLabs.voices.pvc.samples.GetAudioRequest} request
    ...
    public get(
        ...
        return core.HttpResponsePromise.fromPromise(this.__get(voice_id, sample_id, request, requestOptions));
    }
    ...
    private async __get(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `v1/voices/pvc/${core.url.encodePathParam(voice_id)}/samples/${core.url.encodePathParam(sample_id)}/audio`,
            ),
            method: "GET",
            headers: _headers,
