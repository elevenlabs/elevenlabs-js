...
import { WaveformClient } from "../resources/waveform/client/Client.js";
...
export class SamplesClient {
    ...
    public get waveform(): WaveformClient {
        return (this._waveform ??= new WaveformClient(this._options));
    }
    ...
    private async __update(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.voices.pvc.BodyUpdatePvcVoiceSampleV1VoicesPvcVoiceIdSamplesSampleIdPost.jsonOrThrow(
                    request,
