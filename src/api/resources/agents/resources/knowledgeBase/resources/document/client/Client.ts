...
export class DocumentClient {
     ...
     * @param {ElevenLabs.agents.knowledgeBase.BodyUpdateFileDocumentV1ConvaiKnowledgeBaseDocumentationIdUpdateFilePatch} request
    ...
    ): core.HttpResponsePromise<ElevenLabs.agents.knowledgeBase.UpdateFileDocumentResponse> {
    ...
    private async __updateFile(
        ...
        request: ElevenLabs.agents.knowledgeBase.BodyUpdateFileDocumentV1ConvaiKnowledgeBaseDocumentationIdUpdateFilePatch,
        requestOptions?: DocumentClient.RequestOptions,
    ): Promise<core.WithRawResponse<ElevenLabs.agents.knowledgeBase.UpdateFileDocumentResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.agents.knowledgeBase.UpdateFileDocumentResponse.parseOrThrow(_response.body, {
    ...
    public refresh(
        documentation_id: string,
        requestOptions?: DocumentClient.RequestOptions,
    ): core.HttpResponsePromise<ElevenLabs.agents.knowledgeBase.RefreshDocumentResponse> {
    ...
    private async __refresh(
        documentation_id: string,
        requestOptions?: DocumentClient.RequestOptions,
    ): Promise<core.WithRawResponse<ElevenLabs.agents.knowledgeBase.RefreshDocumentResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "xi-api-key": requestOptions?.apiKey ?? this._options?.apiKey ?? process.env?.ELEVENLABS_API_KEY,
        ...
        if (_response.ok) {
            return {
                data: serializers.agents.knowledgeBase.RefreshDocumentResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    breadcrumbsPrefix: ["response"],
     ...
     *
     * @param {string} documentation_id - The id of a document from the knowledge base. This is returned on document addition.
     * @param {ElevenLabs.agents.knowledgeBase.RagIndexRequestModel} request
     * @param {DocumentClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link ElevenLabs.UnprocessableEntityError}
     * @throws {@link errors.ElevenLabsError}
    ...
    private async __computeRagIndex(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.agents.knowledgeBase.RagIndexRequestModel.jsonOrThrow(request, {
