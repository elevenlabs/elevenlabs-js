...
export class InvocationsClient {
     ...
     *
     * @param {ElevenLabs.agents.tests.ListInvocationsRequest} request
     ...
     *
     * @param {string} test_invocation_id - The id of a test invocation. This is returned when tests are run.
     * @param {ElevenLabs.agents.tests.ResubmitTestsRequestModel} request
     * @param {InvocationsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link ElevenLabs.UnprocessableEntityError}
     * @throws {@link errors.ElevenLabsError}
    ...
    private async __resubmit(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.agents.tests.ResubmitTestsRequestModel.jsonOrThrow(request, {
