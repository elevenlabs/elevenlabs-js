...
export class ToolApprovalsClient {
     ...
     * @param {ElevenLabs.agents.mcpServers.McpToolAddApprovalRequestModel} request
    ...
    private async __create(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.agents.mcpServers.McpToolAddApprovalRequestModel.jsonOrThrow(request, {
