...
export class SummariesClient {
     ...
     *
     * @param {ElevenLabs.agents.GetSummariesRequest} request
    ...
    ): core.HttpResponsePromise<Record<string, ElevenLabs.agents.GetSummariesResponseValue>> {
    ...
    private async __get(
        request: ElevenLabs.agents.GetSummariesRequest = {},
        requestOptions?: SummariesClient.RequestOptions,
    ): Promise<core.WithRawResponse<Record<string, ElevenLabs.agents.GetSummariesResponseValue>>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.agents.summaries.get.Response.parseOrThrow(_response.body, {
