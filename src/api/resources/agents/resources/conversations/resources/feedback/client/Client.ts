...
export class FeedbackClient {
     ...
     * @param {ElevenLabs.agents.conversations.ConversationFeedbackRequestModel} request
    ...
    private async __create(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.agents.conversations.ConversationFeedbackRequestModel.jsonOrThrow(request, {
