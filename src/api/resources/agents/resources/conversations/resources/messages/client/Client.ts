...
export class MessagesClient {
     ...
     *
     * @param {ElevenLabs.agents.conversations.TextSearchMessagesRequest} request
        ...
        const _queryParams: Record<string, unknown> = {
            ...
            exclude_statuses: Array.isArray(excludeStatuses)
                ? excludeStatuses.map((item) =>
                      serializers.agents.conversations.TextSearchMessagesRequestExcludeStatusesItem.jsonOrThrow(item, {
                          unrecognizedObjectKeys: "strip",
                          omitUndefined: true,
                      }),
                  )
                : excludeStatuses != null
                  ? serializers.agents.conversations.TextSearchMessagesRequestExcludeStatusesItem.jsonOrThrow(
                        excludeStatuses,
            ...
            summary_mode:
                summaryMode != null
                    ? serializers.agents.conversations.TextSearchMessagesRequestSummaryMode.jsonOrThrow(summaryMode, {
                          unrecognizedObjectKeys: "strip",
                          omitUndefined: true,
                      })
                    : undefined,
            ...
            sort_by:
                sortBy != null
                    ? serializers.MessageSearchSortBy.jsonOrThrow(sortBy, {
                          unrecognizedObjectKeys: "strip",
                          omitUndefined: true,
                      })
                    : undefined,
     ...
     *
     * @param {ElevenLabs.agents.conversations.SearchMessagesRequest} request
     * @param {MessagesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link ElevenLabs.UnprocessableEntityError}
     * @throws {@link errors.ElevenLabsError}
