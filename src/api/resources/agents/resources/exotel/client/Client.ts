...
export class ExotelClient {
     ...
     *
     * @param {ElevenLabs.agents.BodyHandleAnOutboundCallViaExotelV1ConvaiExotelOutboundCallPost} request
    ...
    ): core.HttpResponsePromise<ElevenLabs.ExotelOutboundCallResponse> {
    ...
    private async __outboundCall(
        request: ElevenLabs.agents.BodyHandleAnOutboundCallViaExotelV1ConvaiExotelOutboundCallPost,
        requestOptions?: ExotelClient.RequestOptions,
    ): Promise<core.WithRawResponse<ElevenLabs.ExotelOutboundCallResponse>> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.agents.BodyHandleAnOutboundCallViaExotelV1ConvaiExotelOutboundCallPost.jsonOrThrow(
                    request,
        ...
        if (_response.ok) {
            return {
                data: serializers.ExotelOutboundCallResponse.parseOrThrow(_response.body, {
