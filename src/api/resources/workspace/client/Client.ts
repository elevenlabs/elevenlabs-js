...
import { AuditLogsClient } from "../resources/auditLogs/client/Client.js";
import { AuthConnectionsClient } from "../resources/authConnections/client/Client.js";
...
import { ResourcesClient } from "../resources/resources/client/Client.js";
    ...
    private async __setThirdPartyDisablingPolicy(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.BodySetWorkspaceThirdPartyDisablingPolicyV1WorkspacesApiKeysThirdPartyDisablingPost.jsonOrThrow(
                    request,
