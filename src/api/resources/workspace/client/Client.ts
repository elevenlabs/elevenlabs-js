...
export class Workspace {
    ...
    /**
     * @param {ElevenLabs.GetSsoProviderAdminAdminN8EnylacgdSsoProviderGetRequest} request
    ...
    public async getSsoProviderAdmin(
        ...
        if (_response.ok) {
            return _response.body as ElevenLabs.SsoProviderResponseModel;
        }
