 ...
 */
export interface GptImage15Request {
    ...
    quality?: ElevenLabs.GptImage15RequestQuality;
    /** The background of the output image. With `auto`, the model picks the background that suits the image. */
    background?: ElevenLabs.GptImage15RequestBackground;
    /** The aspect ratio of the output image. */
    aspectRatio?: ElevenLabs.GptImage15RequestAspectRatio;
}
