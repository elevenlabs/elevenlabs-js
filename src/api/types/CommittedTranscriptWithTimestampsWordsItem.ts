 ...
 */
export interface CommittedTranscriptWithTimestampsWordsItem {
    ...
    type: ElevenLabs.CommittedTranscriptWithTimestampsWordsItemType;
    ...
    characters?: ElevenLabs.CommittedTranscriptWithTimestampsWordsItemCharactersItem[];
