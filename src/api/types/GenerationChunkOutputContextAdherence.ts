...
export const GenerationChunkOutputContextAdherence = {
    Low: "low",
    Medium: "medium",
    High: "high",
} as const;
export type GenerationChunkOutputContextAdherence =
    (typeof GenerationChunkOutputContextAdherence)[keyof typeof GenerationChunkOutputContextAdherence];
