 ...
 */
export type AstSubtractionOperatorNodeInputLeft =
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.AddOperator
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.AndOperator
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.BooleanLiteral
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.ConditionalOperator
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.DivOperator
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.DynamicVariable
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.EqOperator
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.GtOperator
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.GteOperator
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.Llm
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.LtOperator
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.LteOperator
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.MulOperator
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.NeqOperator
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.NumberLiteral
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.OrOperator
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.StringLiteral
    | ElevenLabs.AstSubtractionOperatorNodeInputLeft.SubOperator;

export namespace AstSubtractionOperatorNodeInputLeft {
