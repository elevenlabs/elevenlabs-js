 ...
 */
export type AstDivisionOperatorNodeInputRight =
    | ElevenLabs.AstDivisionOperatorNodeInputRight.AddOperator
    | ElevenLabs.AstDivisionOperatorNodeInputRight.AndOperator
    | ElevenLabs.AstDivisionOperatorNodeInputRight.BooleanLiteral
    | ElevenLabs.AstDivisionOperatorNodeInputRight.ConditionalOperator
    | ElevenLabs.AstDivisionOperatorNodeInputRight.DivOperator
    | ElevenLabs.AstDivisionOperatorNodeInputRight.DynamicVariable
    | ElevenLabs.AstDivisionOperatorNodeInputRight.EqOperator
    | ElevenLabs.AstDivisionOperatorNodeInputRight.GtOperator
    | ElevenLabs.AstDivisionOperatorNodeInputRight.GteOperator
    | ElevenLabs.AstDivisionOperatorNodeInputRight.Llm
    | ElevenLabs.AstDivisionOperatorNodeInputRight.LtOperator
    | ElevenLabs.AstDivisionOperatorNodeInputRight.LteOperator
    | ElevenLabs.AstDivisionOperatorNodeInputRight.MulOperator
    | ElevenLabs.AstDivisionOperatorNodeInputRight.NeqOperator
    | ElevenLabs.AstDivisionOperatorNodeInputRight.NumberLiteral
    | ElevenLabs.AstDivisionOperatorNodeInputRight.OrOperator
    | ElevenLabs.AstDivisionOperatorNodeInputRight.StringLiteral
    | ElevenLabs.AstDivisionOperatorNodeInputRight.SubOperator;

export namespace AstDivisionOperatorNodeInputRight {
