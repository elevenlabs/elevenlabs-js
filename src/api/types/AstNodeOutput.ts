...
export type AstNodeOutput =
    | ElevenLabs.AstNodeOutput.AddOperator
    | ElevenLabs.AstNodeOutput.AndOperator
    | ElevenLabs.AstNodeOutput.BooleanLiteral
    | ElevenLabs.AstNodeOutput.ConditionalOperator
    | ElevenLabs.AstNodeOutput.DivOperator
    | ElevenLabs.AstNodeOutput.DynamicVariable
    | ElevenLabs.AstNodeOutput.EqOperator
    | ElevenLabs.AstNodeOutput.GtOperator
    | ElevenLabs.AstNodeOutput.GteOperator
    | ElevenLabs.AstNodeOutput.Llm
    | ElevenLabs.AstNodeOutput.LtOperator
    ...
    | ElevenLabs.AstNodeOutput.SubOperator;

export namespace AstNodeOutput {
