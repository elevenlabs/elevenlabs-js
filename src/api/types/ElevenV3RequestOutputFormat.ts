...
export const ElevenV3RequestOutputFormat = {
...
export type ElevenV3RequestOutputFormat =
    (typeof ElevenV3RequestOutputFormat)[keyof typeof ElevenV3RequestOutputFormat];
