...
export interface ConversationalConfigApiModelInput {
    ...
    language_presets?: Record<string, ElevenLabs.LanguagePresetInput>;
    /** Agent specific configuration */
    agent?: ElevenLabs.AgentConfigApiModelInput;
}
