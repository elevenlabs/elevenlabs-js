 ...
 */
export interface GptImage25FlareRequest {
    ...
    quality?: ElevenLabs.GptImage25FlareRequestQuality;
    /** The aspect ratio of the output image. With `auto`, the model picks an aspect ratio based on the inputs. */
    aspectRatio?: ElevenLabs.GptImage25FlareRequestAspectRatio;
    /** The resolution of the output image. */
    resolution?: ElevenLabs.GptImage25FlareRequestResolution;
}
