 ...
 */
export interface FinalTranscriptWithTimestampsWordsItem {
    ...
    type: ElevenLabs.FinalTranscriptWithTimestampsWordsItemType;
    ...
    characters?: ElevenLabs.FinalTranscriptWithTimestampsWordsItemCharactersItem[];
