 ...
 */
export type AstMultiplicationOperatorNodeInputLeft =
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.AddOperator
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.AndOperator
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.BooleanLiteral
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.ConditionalOperator
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.DivOperator
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.DynamicVariable
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.EqOperator
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.GtOperator
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.GteOperator
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.Llm
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.LtOperator
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.LteOperator
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.MulOperator
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.NeqOperator
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.NumberLiteral
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.OrOperator
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.StringLiteral
    | ElevenLabs.AstMultiplicationOperatorNodeInputLeft.SubOperator;

export namespace AstMultiplicationOperatorNodeInputLeft {
