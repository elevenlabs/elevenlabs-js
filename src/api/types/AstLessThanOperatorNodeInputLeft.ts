 ...
 */
export type AstLessThanOperatorNodeInputLeft =
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.AddOperator
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.AndOperator
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.BooleanLiteral
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.ConditionalOperator
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.DivOperator
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.DynamicVariable
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.EqOperator
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.GtOperator
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.GteOperator
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.Llm
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.LtOperator
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.LteOperator
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.MulOperator
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.NeqOperator
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.NumberLiteral
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.OrOperator
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.StringLiteral
    | ElevenLabs.AstLessThanOperatorNodeInputLeft.SubOperator;

export namespace AstLessThanOperatorNodeInputLeft {
