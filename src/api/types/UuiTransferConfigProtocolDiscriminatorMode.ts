...
export const UuiTransferConfigProtocolDiscriminatorMode = {
    Prefix: "prefix",
    PdParameter: "pd_parameter",
} as const;
export type UuiTransferConfigProtocolDiscriminatorMode =
    (typeof UuiTransferConfigProtocolDiscriminatorMode)[keyof typeof UuiTransferConfigProtocolDiscriminatorMode];
