 ...
 */
export type AstAdditionOperatorNodeInputLeft =
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.AddOperator
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.AndOperator
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.BooleanLiteral
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.ConditionalOperator
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.DivOperator
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.DynamicVariable
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.EqOperator
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.GtOperator
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.GteOperator
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.Llm
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.LtOperator
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.LteOperator
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.MulOperator
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.NeqOperator
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.NumberLiteral
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.OrOperator
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.StringLiteral
    | ElevenLabs.AstAdditionOperatorNodeInputLeft.SubOperator;

export namespace AstAdditionOperatorNodeInputLeft {
