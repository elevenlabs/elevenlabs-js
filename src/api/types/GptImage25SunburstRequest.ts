 ...
 */
export interface GptImage25SunburstRequest {
    ...
    quality?: ElevenLabs.GptImage25SunburstRequestQuality;
    /** The aspect ratio of the output image. With `auto`, the model picks an aspect ratio based on the inputs. */
    aspectRatio?: ElevenLabs.GptImage25SunburstRequestAspectRatio;
    /** The resolution of the output image. */
    resolution?: ElevenLabs.GptImage25SunburstRequestResolution;
}
