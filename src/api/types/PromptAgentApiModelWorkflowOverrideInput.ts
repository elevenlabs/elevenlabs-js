...
export interface PromptAgentApiModelWorkflowOverrideInput {
    ...
    builtInTools?: ElevenLabs.BuiltInToolsWorkflowOverrideInput;
    ...
    rag?: ElevenLabs.RagConfigWorkflowOverrideInput;
