 ...
 */
export interface Gemini31FlashImageRequest {
    ...
    aspectRatio?: ElevenLabs.Gemini31FlashImageRequestAspectRatio;
    /** The resolution of the output image. */
    resolution?: ElevenLabs.Gemini31FlashImageRequestResolution;
}
