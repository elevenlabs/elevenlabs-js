 ...
 */
export type AstDivisionOperatorNodeInputLeft =
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.AddOperator
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.AndOperator
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.BooleanLiteral
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.ConditionalOperator
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.DivOperator
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.DynamicVariable
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.EqOperator
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.GtOperator
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.GteOperator
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.Llm
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.LtOperator
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.LteOperator
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.MulOperator
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.NeqOperator
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.NumberLiteral
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.OrOperator
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.StringLiteral
    | ElevenLabs.AstDivisionOperatorNodeInputLeft.SubOperator;

export namespace AstDivisionOperatorNodeInputLeft {
