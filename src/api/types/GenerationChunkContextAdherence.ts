...
export const GenerationChunkContextAdherence = {
    Low: "low",
    Medium: "medium",
    High: "high",
} as const;
export type GenerationChunkContextAdherence =
    (typeof GenerationChunkContextAdherence)[keyof typeof GenerationChunkContextAdherence];
