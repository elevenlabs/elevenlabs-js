...
export const AstDivisionOperatorNodeOutputLeft: core.serialization.Schema<
    serializers.AstDivisionOperatorNodeOutputLeft.Raw,
    ElevenLabs.AstDivisionOperatorNodeOutputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstDivisionOperatorNodeOutputLeft>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstDivisionOperatorNodeOutputLeft {
    export type Raw =
        | AstDivisionOperatorNodeOutputLeft.AddOperator
        | AstDivisionOperatorNodeOutputLeft.AndOperator
        | AstDivisionOperatorNodeOutputLeft.BooleanLiteral
        | AstDivisionOperatorNodeOutputLeft.ConditionalOperator
        | AstDivisionOperatorNodeOutputLeft.DivOperator
        | AstDivisionOperatorNodeOutputLeft.DynamicVariable
        | AstDivisionOperatorNodeOutputLeft.EqOperator
        | AstDivisionOperatorNodeOutputLeft.GtOperator
        | AstDivisionOperatorNodeOutputLeft.GteOperator
        | AstDivisionOperatorNodeOutputLeft.Llm
        | AstDivisionOperatorNodeOutputLeft.LtOperator
        | AstDivisionOperatorNodeOutputLeft.LteOperator
        | AstDivisionOperatorNodeOutputLeft.MulOperator
        | AstDivisionOperatorNodeOutputLeft.NeqOperator
        | AstDivisionOperatorNodeOutputLeft.NumberLiteral
        | AstDivisionOperatorNodeOutputLeft.OrOperator
        | AstDivisionOperatorNodeOutputLeft.StringLiteral
        | AstDivisionOperatorNodeOutputLeft.SubOperator;
