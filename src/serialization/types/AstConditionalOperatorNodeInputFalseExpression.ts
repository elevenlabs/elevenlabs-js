...
export const AstConditionalOperatorNodeInputFalseExpression: core.serialization.Schema<
    serializers.AstConditionalOperatorNodeInputFalseExpression.Raw,
    ElevenLabs.AstConditionalOperatorNodeInputFalseExpression
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstConditionalOperatorNodeInputFalseExpression>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstConditionalOperatorNodeInputFalseExpression {
    export type Raw =
        | AstConditionalOperatorNodeInputFalseExpression.AddOperator
        | AstConditionalOperatorNodeInputFalseExpression.AndOperator
        | AstConditionalOperatorNodeInputFalseExpression.BooleanLiteral
        | AstConditionalOperatorNodeInputFalseExpression.ConditionalOperator
        | AstConditionalOperatorNodeInputFalseExpression.DivOperator
        | AstConditionalOperatorNodeInputFalseExpression.DynamicVariable
        | AstConditionalOperatorNodeInputFalseExpression.EqOperator
        | AstConditionalOperatorNodeInputFalseExpression.GtOperator
        | AstConditionalOperatorNodeInputFalseExpression.GteOperator
        | AstConditionalOperatorNodeInputFalseExpression.Llm
        | AstConditionalOperatorNodeInputFalseExpression.LtOperator
        | AstConditionalOperatorNodeInputFalseExpression.LteOperator
        | AstConditionalOperatorNodeInputFalseExpression.MulOperator
        | AstConditionalOperatorNodeInputFalseExpression.NeqOperator
        | AstConditionalOperatorNodeInputFalseExpression.NumberLiteral
        | AstConditionalOperatorNodeInputFalseExpression.OrOperator
        | AstConditionalOperatorNodeInputFalseExpression.StringLiteral
        | AstConditionalOperatorNodeInputFalseExpression.SubOperator;
