...
export const AstAdditionOperatorNodeInputRight: core.serialization.Schema<
    serializers.AstAdditionOperatorNodeInputRight.Raw,
    ElevenLabs.AstAdditionOperatorNodeInputRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstAdditionOperatorNodeInputRight>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstAdditionOperatorNodeInputRight {
    export type Raw =
        | AstAdditionOperatorNodeInputRight.AddOperator
        | AstAdditionOperatorNodeInputRight.AndOperator
        | AstAdditionOperatorNodeInputRight.BooleanLiteral
        | AstAdditionOperatorNodeInputRight.ConditionalOperator
        | AstAdditionOperatorNodeInputRight.DivOperator
        | AstAdditionOperatorNodeInputRight.DynamicVariable
        | AstAdditionOperatorNodeInputRight.EqOperator
        | AstAdditionOperatorNodeInputRight.GtOperator
        | AstAdditionOperatorNodeInputRight.GteOperator
        | AstAdditionOperatorNodeInputRight.Llm
        | AstAdditionOperatorNodeInputRight.LtOperator
        | AstAdditionOperatorNodeInputRight.LteOperator
        | AstAdditionOperatorNodeInputRight.MulOperator
        | AstAdditionOperatorNodeInputRight.NeqOperator
        | AstAdditionOperatorNodeInputRight.NumberLiteral
        | AstAdditionOperatorNodeInputRight.OrOperator
        | AstAdditionOperatorNodeInputRight.StringLiteral
        | AstAdditionOperatorNodeInputRight.SubOperator;
