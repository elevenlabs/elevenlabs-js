...
export const AstAdditionOperatorNodeOutputLeft: core.serialization.Schema<
    serializers.AstAdditionOperatorNodeOutputLeft.Raw,
    ElevenLabs.AstAdditionOperatorNodeOutputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstAdditionOperatorNodeOutputLeft>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstAdditionOperatorNodeOutputLeft {
    export type Raw =
        | AstAdditionOperatorNodeOutputLeft.AddOperator
        | AstAdditionOperatorNodeOutputLeft.AndOperator
        | AstAdditionOperatorNodeOutputLeft.BooleanLiteral
        | AstAdditionOperatorNodeOutputLeft.ConditionalOperator
        | AstAdditionOperatorNodeOutputLeft.DivOperator
        | AstAdditionOperatorNodeOutputLeft.DynamicVariable
        | AstAdditionOperatorNodeOutputLeft.EqOperator
        | AstAdditionOperatorNodeOutputLeft.GtOperator
        | AstAdditionOperatorNodeOutputLeft.GteOperator
        | AstAdditionOperatorNodeOutputLeft.Llm
        | AstAdditionOperatorNodeOutputLeft.LtOperator
        | AstAdditionOperatorNodeOutputLeft.LteOperator
        | AstAdditionOperatorNodeOutputLeft.MulOperator
        | AstAdditionOperatorNodeOutputLeft.NeqOperator
        | AstAdditionOperatorNodeOutputLeft.NumberLiteral
        | AstAdditionOperatorNodeOutputLeft.OrOperator
        | AstAdditionOperatorNodeOutputLeft.StringLiteral
        | AstAdditionOperatorNodeOutputLeft.SubOperator;
