...
export const AstLessThanOrEqualsOperatorNodeLeft: core.serialization.Schema<
    serializers.AstLessThanOrEqualsOperatorNodeLeft.Raw,
    ElevenLabs.AstLessThanOrEqualsOperatorNodeLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstLessThanOrEqualsOperatorNodeLeft>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstLessThanOrEqualsOperatorNodeLeft {
    export type Raw =
        | AstLessThanOrEqualsOperatorNodeLeft.AndOperator
        | AstLessThanOrEqualsOperatorNodeLeft.BooleanLiteral
        | AstLessThanOrEqualsOperatorNodeLeft.DynamicVariable
        | AstLessThanOrEqualsOperatorNodeLeft.EqOperator
        | AstLessThanOrEqualsOperatorNodeLeft.GtOperator
        | AstLessThanOrEqualsOperatorNodeLeft.GteOperator
        | AstLessThanOrEqualsOperatorNodeLeft.Llm
        | AstLessThanOrEqualsOperatorNodeLeft.LtOperator
        | AstLessThanOrEqualsOperatorNodeLeft.LteOperator
        | AstLessThanOrEqualsOperatorNodeLeft.NeqOperator
        | AstLessThanOrEqualsOperatorNodeLeft.NumberLiteral
        | AstLessThanOrEqualsOperatorNodeLeft.OrOperator
        | AstLessThanOrEqualsOperatorNodeLeft.StringLiteral;
