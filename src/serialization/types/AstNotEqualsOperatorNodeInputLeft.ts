...
export const AstNotEqualsOperatorNodeInputLeft: core.serialization.Schema<
    serializers.AstNotEqualsOperatorNodeInputLeft.Raw,
    ElevenLabs.AstNotEqualsOperatorNodeInputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstNotEqualsOperatorNodeInputLeft>({
...
export declare namespace AstNotEqualsOperatorNodeInputLeft {
    export type Raw =
        | AstNotEqualsOperatorNodeInputLeft.AddOperator
        | AstNotEqualsOperatorNodeInputLeft.AndOperator
        | AstNotEqualsOperatorNodeInputLeft.BooleanLiteral
        | AstNotEqualsOperatorNodeInputLeft.ConditionalOperator
        | AstNotEqualsOperatorNodeInputLeft.DivOperator
        | AstNotEqualsOperatorNodeInputLeft.DynamicVariable
        | AstNotEqualsOperatorNodeInputLeft.EqOperator
        | AstNotEqualsOperatorNodeInputLeft.GtOperator
        | AstNotEqualsOperatorNodeInputLeft.GteOperator
        | AstNotEqualsOperatorNodeInputLeft.Llm
        | AstNotEqualsOperatorNodeInputLeft.LtOperator
        | AstNotEqualsOperatorNodeInputLeft.LteOperator
        | AstNotEqualsOperatorNodeInputLeft.MulOperator
        | AstNotEqualsOperatorNodeInputLeft.NeqOperator
        | AstNotEqualsOperatorNodeInputLeft.NumberLiteral
        | AstNotEqualsOperatorNodeInputLeft.OrOperator
        | AstNotEqualsOperatorNodeInputLeft.StringLiteral
        | AstNotEqualsOperatorNodeInputLeft.SubOperator;
