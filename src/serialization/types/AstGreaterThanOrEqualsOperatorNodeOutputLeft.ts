...
export const AstGreaterThanOrEqualsOperatorNodeOutputLeft: core.serialization.Schema<
    serializers.AstGreaterThanOrEqualsOperatorNodeOutputLeft.Raw,
    ElevenLabs.AstGreaterThanOrEqualsOperatorNodeOutputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstGreaterThanOrEqualsOperatorNodeOutputLeft>({
...
export declare namespace AstGreaterThanOrEqualsOperatorNodeOutputLeft {
    export type Raw =
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.AddOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.AndOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.BooleanLiteral
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.ConditionalOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.DivOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.DynamicVariable
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.EqOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.GtOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.GteOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.Llm
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.LtOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.LteOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.MulOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.NeqOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.NumberLiteral
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.OrOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.StringLiteral
        | AstGreaterThanOrEqualsOperatorNodeOutputLeft.SubOperator;
