...
export const AstMultiplicationOperatorNodeInputRight: core.serialization.Schema<
    serializers.AstMultiplicationOperatorNodeInputRight.Raw,
    ElevenLabs.AstMultiplicationOperatorNodeInputRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstMultiplicationOperatorNodeInputRight>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstMultiplicationOperatorNodeInputRight {
    export type Raw =
        | AstMultiplicationOperatorNodeInputRight.AddOperator
        | AstMultiplicationOperatorNodeInputRight.AndOperator
        | AstMultiplicationOperatorNodeInputRight.BooleanLiteral
        | AstMultiplicationOperatorNodeInputRight.ConditionalOperator
        | AstMultiplicationOperatorNodeInputRight.DivOperator
        | AstMultiplicationOperatorNodeInputRight.DynamicVariable
        | AstMultiplicationOperatorNodeInputRight.EqOperator
        | AstMultiplicationOperatorNodeInputRight.GtOperator
        | AstMultiplicationOperatorNodeInputRight.GteOperator
        | AstMultiplicationOperatorNodeInputRight.Llm
        | AstMultiplicationOperatorNodeInputRight.LtOperator
        | AstMultiplicationOperatorNodeInputRight.LteOperator
        | AstMultiplicationOperatorNodeInputRight.MulOperator
        | AstMultiplicationOperatorNodeInputRight.NeqOperator
        | AstMultiplicationOperatorNodeInputRight.NumberLiteral
        | AstMultiplicationOperatorNodeInputRight.OrOperator
        | AstMultiplicationOperatorNodeInputRight.StringLiteral
        | AstMultiplicationOperatorNodeInputRight.SubOperator;
