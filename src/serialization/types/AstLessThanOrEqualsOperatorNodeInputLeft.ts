...
export const AstLessThanOrEqualsOperatorNodeInputLeft: core.serialization.Schema<
    serializers.AstLessThanOrEqualsOperatorNodeInputLeft.Raw,
    ElevenLabs.AstLessThanOrEqualsOperatorNodeInputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstLessThanOrEqualsOperatorNodeInputLeft>({
...
export declare namespace AstLessThanOrEqualsOperatorNodeInputLeft {
    export type Raw =
        | AstLessThanOrEqualsOperatorNodeInputLeft.AddOperator
        | AstLessThanOrEqualsOperatorNodeInputLeft.AndOperator
        | AstLessThanOrEqualsOperatorNodeInputLeft.BooleanLiteral
        | AstLessThanOrEqualsOperatorNodeInputLeft.ConditionalOperator
        | AstLessThanOrEqualsOperatorNodeInputLeft.DivOperator
        | AstLessThanOrEqualsOperatorNodeInputLeft.DynamicVariable
        | AstLessThanOrEqualsOperatorNodeInputLeft.EqOperator
        | AstLessThanOrEqualsOperatorNodeInputLeft.GtOperator
        | AstLessThanOrEqualsOperatorNodeInputLeft.GteOperator
        | AstLessThanOrEqualsOperatorNodeInputLeft.Llm
        | AstLessThanOrEqualsOperatorNodeInputLeft.LtOperator
        | AstLessThanOrEqualsOperatorNodeInputLeft.LteOperator
        | AstLessThanOrEqualsOperatorNodeInputLeft.MulOperator
        | AstLessThanOrEqualsOperatorNodeInputLeft.NeqOperator
        | AstLessThanOrEqualsOperatorNodeInputLeft.NumberLiteral
        | AstLessThanOrEqualsOperatorNodeInputLeft.OrOperator
        | AstLessThanOrEqualsOperatorNodeInputLeft.StringLiteral
        | AstLessThanOrEqualsOperatorNodeInputLeft.SubOperator;
