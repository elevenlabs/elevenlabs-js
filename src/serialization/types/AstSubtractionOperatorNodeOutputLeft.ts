...
export const AstSubtractionOperatorNodeOutputLeft: core.serialization.Schema<
    serializers.AstSubtractionOperatorNodeOutputLeft.Raw,
    ElevenLabs.AstSubtractionOperatorNodeOutputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstSubtractionOperatorNodeOutputLeft>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstSubtractionOperatorNodeOutputLeft {
    export type Raw =
        | AstSubtractionOperatorNodeOutputLeft.AddOperator
        | AstSubtractionOperatorNodeOutputLeft.AndOperator
        | AstSubtractionOperatorNodeOutputLeft.BooleanLiteral
        | AstSubtractionOperatorNodeOutputLeft.ConditionalOperator
        | AstSubtractionOperatorNodeOutputLeft.DivOperator
        | AstSubtractionOperatorNodeOutputLeft.DynamicVariable
        | AstSubtractionOperatorNodeOutputLeft.EqOperator
        | AstSubtractionOperatorNodeOutputLeft.GtOperator
        | AstSubtractionOperatorNodeOutputLeft.GteOperator
        | AstSubtractionOperatorNodeOutputLeft.Llm
        | AstSubtractionOperatorNodeOutputLeft.LtOperator
        | AstSubtractionOperatorNodeOutputLeft.LteOperator
        | AstSubtractionOperatorNodeOutputLeft.MulOperator
        | AstSubtractionOperatorNodeOutputLeft.NeqOperator
        | AstSubtractionOperatorNodeOutputLeft.NumberLiteral
        | AstSubtractionOperatorNodeOutputLeft.OrOperator
        | AstSubtractionOperatorNodeOutputLeft.StringLiteral
        | AstSubtractionOperatorNodeOutputLeft.SubOperator;
