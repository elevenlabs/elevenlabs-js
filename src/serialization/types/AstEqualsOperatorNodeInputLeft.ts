...
export const AstEqualsOperatorNodeInputLeft: core.serialization.Schema<
    serializers.AstEqualsOperatorNodeInputLeft.Raw,
    ElevenLabs.AstEqualsOperatorNodeInputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstEqualsOperatorNodeInputLeft>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstEqualsOperatorNodeInputLeft {
    export type Raw =
        | AstEqualsOperatorNodeInputLeft.AddOperator
        | AstEqualsOperatorNodeInputLeft.AndOperator
        | AstEqualsOperatorNodeInputLeft.BooleanLiteral
        | AstEqualsOperatorNodeInputLeft.ConditionalOperator
        | AstEqualsOperatorNodeInputLeft.DivOperator
        | AstEqualsOperatorNodeInputLeft.DynamicVariable
        | AstEqualsOperatorNodeInputLeft.EqOperator
        | AstEqualsOperatorNodeInputLeft.GtOperator
        | AstEqualsOperatorNodeInputLeft.GteOperator
        | AstEqualsOperatorNodeInputLeft.Llm
        | AstEqualsOperatorNodeInputLeft.LtOperator
        | AstEqualsOperatorNodeInputLeft.LteOperator
        | AstEqualsOperatorNodeInputLeft.MulOperator
        | AstEqualsOperatorNodeInputLeft.NeqOperator
        | AstEqualsOperatorNodeInputLeft.NumberLiteral
        | AstEqualsOperatorNodeInputLeft.OrOperator
        | AstEqualsOperatorNodeInputLeft.StringLiteral
        | AstEqualsOperatorNodeInputLeft.SubOperator;
