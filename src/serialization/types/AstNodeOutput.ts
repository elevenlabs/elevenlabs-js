...
import { AstBooleanNodeOutput } from "./AstBooleanNodeOutput.js";
import { AstDynamicVariableNodeOutput } from "./AstDynamicVariableNodeOutput.js";
import { AstllmNodeOutput } from "./AstllmNodeOutput.js";
import { AstNullNodeOutput } from "./AstNullNodeOutput.js";
import { AstNumberNodeOutput } from "./AstNumberNodeOutput.js";
import { AstStringNodeOutput } from "./AstStringNodeOutput.js";

export const AstNodeOutput: core.serialization.Schema<serializers.AstNodeOutput.Raw, ElevenLabs.AstNodeOutput> =
    core.serialization
        .union("type", {
            ...
            null_literal: AstNullNodeOutput,
        ...
        .transform<ElevenLabs.AstNodeOutput>({
...
export declare namespace AstNodeOutput {
    export type Raw =
        | AstNodeOutput.AddOperator
        | AstNodeOutput.AndOperator
        | AstNodeOutput.BooleanLiteral
        | AstNodeOutput.ConditionalOperator
        | AstNodeOutput.DivOperator
        | AstNodeOutput.DynamicVariable
        | AstNodeOutput.EqOperator
        | AstNodeOutput.GtOperator
        | AstNodeOutput.GteOperator
        | AstNodeOutput.Llm
        | AstNodeOutput.LtOperator
        | AstNodeOutput.LteOperator
        | AstNodeOutput.MulOperator
        | AstNodeOutput.NeqOperator
        | AstNodeOutput.NullLiteral
        | AstNodeOutput.NumberLiteral
        | AstNodeOutput.OrOperator
        | AstNodeOutput.StringLiteral
        | AstNodeOutput.SubOperator;
    ...
    export interface NullLiteral extends AstNullNodeOutput.Raw {
        type: "null_literal";
    }
