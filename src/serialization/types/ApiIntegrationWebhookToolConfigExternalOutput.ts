...
export const ApiIntegrationWebhookToolConfigExternalOutput: core.serialization.ObjectSchema<
    serializers.ApiIntegrationWebhookToolConfigExternalOutput.Raw,
    ElevenLabs.ApiIntegrationWebhookToolConfigExternalOutput
> = core.serialization.object({
    ...
    baseApiSchema: core.serialization.property("base_api_schema", WebhookToolApiSchemaConfigOutput),
});
