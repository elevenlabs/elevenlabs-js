...
export const AstEqualsOperatorNodeRight: core.serialization.Schema<
    serializers.AstEqualsOperatorNodeRight.Raw,
    ElevenLabs.AstEqualsOperatorNodeRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstEqualsOperatorNodeRight>({
...
export declare namespace AstEqualsOperatorNodeRight {
    export type Raw =
        | AstEqualsOperatorNodeRight.AndOperator
        | AstEqualsOperatorNodeRight.BooleanLiteral
        | AstEqualsOperatorNodeRight.DynamicVariable
        | AstEqualsOperatorNodeRight.EqOperator
        | AstEqualsOperatorNodeRight.GtOperator
        | AstEqualsOperatorNodeRight.GteOperator
        | AstEqualsOperatorNodeRight.Llm
        | AstEqualsOperatorNodeRight.LtOperator
        | AstEqualsOperatorNodeRight.LteOperator
        | AstEqualsOperatorNodeRight.NeqOperator
        | AstEqualsOperatorNodeRight.NumberLiteral
        | AstEqualsOperatorNodeRight.OrOperator
        | AstEqualsOperatorNodeRight.StringLiteral;
