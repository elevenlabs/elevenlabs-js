...
export const AstLessThanOperatorNodeLeft: core.serialization.Schema<
    serializers.AstLessThanOperatorNodeLeft.Raw,
    ElevenLabs.AstLessThanOperatorNodeLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstLessThanOperatorNodeLeft>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstLessThanOperatorNodeLeft {
    export type Raw =
        | AstLessThanOperatorNodeLeft.AndOperator
        | AstLessThanOperatorNodeLeft.BooleanLiteral
        | AstLessThanOperatorNodeLeft.DynamicVariable
        | AstLessThanOperatorNodeLeft.EqOperator
        | AstLessThanOperatorNodeLeft.GtOperator
        | AstLessThanOperatorNodeLeft.GteOperator
        | AstLessThanOperatorNodeLeft.Llm
        | AstLessThanOperatorNodeLeft.LtOperator
        | AstLessThanOperatorNodeLeft.LteOperator
        | AstLessThanOperatorNodeLeft.NeqOperator
        | AstLessThanOperatorNodeLeft.NumberLiteral
        | AstLessThanOperatorNodeLeft.OrOperator
        | AstLessThanOperatorNodeLeft.StringLiteral;
