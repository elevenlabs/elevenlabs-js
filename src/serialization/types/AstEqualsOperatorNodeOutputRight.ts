...
export const AstEqualsOperatorNodeOutputRight: core.serialization.Schema<
    serializers.AstEqualsOperatorNodeOutputRight.Raw,
    ElevenLabs.AstEqualsOperatorNodeOutputRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstEqualsOperatorNodeOutputRight>({
...
export declare namespace AstEqualsOperatorNodeOutputRight {
    export type Raw =
        | AstEqualsOperatorNodeOutputRight.AddOperator
        | AstEqualsOperatorNodeOutputRight.AndOperator
        | AstEqualsOperatorNodeOutputRight.BooleanLiteral
        | AstEqualsOperatorNodeOutputRight.ConditionalOperator
        | AstEqualsOperatorNodeOutputRight.DivOperator
        | AstEqualsOperatorNodeOutputRight.DynamicVariable
        | AstEqualsOperatorNodeOutputRight.EqOperator
        | AstEqualsOperatorNodeOutputRight.GtOperator
        | AstEqualsOperatorNodeOutputRight.GteOperator
        | AstEqualsOperatorNodeOutputRight.Llm
        | AstEqualsOperatorNodeOutputRight.LtOperator
        | AstEqualsOperatorNodeOutputRight.LteOperator
        | AstEqualsOperatorNodeOutputRight.MulOperator
        | AstEqualsOperatorNodeOutputRight.NeqOperator
        | AstEqualsOperatorNodeOutputRight.NumberLiteral
        | AstEqualsOperatorNodeOutputRight.OrOperator
        | AstEqualsOperatorNodeOutputRight.StringLiteral
        | AstEqualsOperatorNodeOutputRight.SubOperator;
