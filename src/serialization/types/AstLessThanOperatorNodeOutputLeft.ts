...
export const AstLessThanOperatorNodeOutputLeft: core.serialization.Schema<
    serializers.AstLessThanOperatorNodeOutputLeft.Raw,
    ElevenLabs.AstLessThanOperatorNodeOutputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstLessThanOperatorNodeOutputLeft>({
...
export declare namespace AstLessThanOperatorNodeOutputLeft {
    export type Raw =
        | AstLessThanOperatorNodeOutputLeft.AddOperator
        ...
        | AstLessThanOperatorNodeOutputLeft.DivOperator
        ...
        | AstLessThanOperatorNodeOutputLeft.GteOperator
        | AstLessThanOperatorNodeOutputLeft.Llm
        | AstLessThanOperatorNodeOutputLeft.LtOperator
        | AstLessThanOperatorNodeOutputLeft.LteOperator
        | AstLessThanOperatorNodeOutputLeft.MulOperator
        | AstLessThanOperatorNodeOutputLeft.NeqOperator
        | AstLessThanOperatorNodeOutputLeft.NumberLiteral
        | AstLessThanOperatorNodeOutputLeft.OrOperator
        | AstLessThanOperatorNodeOutputLeft.StringLiteral
        | AstLessThanOperatorNodeOutputLeft.SubOperator;
