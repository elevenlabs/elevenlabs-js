...
export const AstSubtractionOperatorNodeInputLeft: core.serialization.Schema<
    serializers.AstSubtractionOperatorNodeInputLeft.Raw,
    ElevenLabs.AstSubtractionOperatorNodeInputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstSubtractionOperatorNodeInputLeft>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstSubtractionOperatorNodeInputLeft {
    export type Raw =
        | AstSubtractionOperatorNodeInputLeft.AddOperator
        | AstSubtractionOperatorNodeInputLeft.AndOperator
        | AstSubtractionOperatorNodeInputLeft.BooleanLiteral
        | AstSubtractionOperatorNodeInputLeft.ConditionalOperator
        | AstSubtractionOperatorNodeInputLeft.DivOperator
        | AstSubtractionOperatorNodeInputLeft.DynamicVariable
        | AstSubtractionOperatorNodeInputLeft.EqOperator
        | AstSubtractionOperatorNodeInputLeft.GtOperator
        | AstSubtractionOperatorNodeInputLeft.GteOperator
        | AstSubtractionOperatorNodeInputLeft.Llm
        | AstSubtractionOperatorNodeInputLeft.LtOperator
        | AstSubtractionOperatorNodeInputLeft.LteOperator
        | AstSubtractionOperatorNodeInputLeft.MulOperator
        | AstSubtractionOperatorNodeInputLeft.NeqOperator
        | AstSubtractionOperatorNodeInputLeft.NumberLiteral
        | AstSubtractionOperatorNodeInputLeft.OrOperator
        | AstSubtractionOperatorNodeInputLeft.StringLiteral
        | AstSubtractionOperatorNodeInputLeft.SubOperator;
