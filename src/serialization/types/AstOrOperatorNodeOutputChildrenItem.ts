...
export const AstOrOperatorNodeOutputChildrenItem: core.serialization.Schema<
    serializers.AstOrOperatorNodeOutputChildrenItem.Raw,
    ElevenLabs.AstOrOperatorNodeOutputChildrenItem
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstOrOperatorNodeOutputChildrenItem>({
...
export declare namespace AstOrOperatorNodeOutputChildrenItem {
    export type Raw =
        | AstOrOperatorNodeOutputChildrenItem.AddOperator
        | AstOrOperatorNodeOutputChildrenItem.AndOperator
        | AstOrOperatorNodeOutputChildrenItem.BooleanLiteral
        | AstOrOperatorNodeOutputChildrenItem.ConditionalOperator
        | AstOrOperatorNodeOutputChildrenItem.DivOperator
        | AstOrOperatorNodeOutputChildrenItem.DynamicVariable
        | AstOrOperatorNodeOutputChildrenItem.EqOperator
        | AstOrOperatorNodeOutputChildrenItem.GtOperator
        | AstOrOperatorNodeOutputChildrenItem.GteOperator
        | AstOrOperatorNodeOutputChildrenItem.Llm
        | AstOrOperatorNodeOutputChildrenItem.LtOperator
        | AstOrOperatorNodeOutputChildrenItem.LteOperator
        | AstOrOperatorNodeOutputChildrenItem.MulOperator
        | AstOrOperatorNodeOutputChildrenItem.NeqOperator
        | AstOrOperatorNodeOutputChildrenItem.NumberLiteral
        | AstOrOperatorNodeOutputChildrenItem.OrOperator
        | AstOrOperatorNodeOutputChildrenItem.StringLiteral
        | AstOrOperatorNodeOutputChildrenItem.SubOperator;
