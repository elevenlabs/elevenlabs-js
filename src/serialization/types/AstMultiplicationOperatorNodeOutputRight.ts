...
export const AstMultiplicationOperatorNodeOutputRight: core.serialization.Schema<
    serializers.AstMultiplicationOperatorNodeOutputRight.Raw,
    ElevenLabs.AstMultiplicationOperatorNodeOutputRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstMultiplicationOperatorNodeOutputRight>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstMultiplicationOperatorNodeOutputRight {
    export type Raw =
        | AstMultiplicationOperatorNodeOutputRight.AddOperator
        | AstMultiplicationOperatorNodeOutputRight.AndOperator
        | AstMultiplicationOperatorNodeOutputRight.BooleanLiteral
        | AstMultiplicationOperatorNodeOutputRight.ConditionalOperator
        | AstMultiplicationOperatorNodeOutputRight.DivOperator
        | AstMultiplicationOperatorNodeOutputRight.DynamicVariable
        | AstMultiplicationOperatorNodeOutputRight.EqOperator
        | AstMultiplicationOperatorNodeOutputRight.GtOperator
        | AstMultiplicationOperatorNodeOutputRight.GteOperator
        | AstMultiplicationOperatorNodeOutputRight.Llm
        | AstMultiplicationOperatorNodeOutputRight.LtOperator
        | AstMultiplicationOperatorNodeOutputRight.LteOperator
        | AstMultiplicationOperatorNodeOutputRight.MulOperator
        | AstMultiplicationOperatorNodeOutputRight.NeqOperator
        | AstMultiplicationOperatorNodeOutputRight.NumberLiteral
        | AstMultiplicationOperatorNodeOutputRight.OrOperator
        | AstMultiplicationOperatorNodeOutputRight.StringLiteral
        | AstMultiplicationOperatorNodeOutputRight.SubOperator;
