...
export const AstOrOperatorNodeChildrenItem: core.serialization.Schema<
    serializers.AstOrOperatorNodeChildrenItem.Raw,
    ElevenLabs.AstOrOperatorNodeChildrenItem
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstOrOperatorNodeChildrenItem>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstOrOperatorNodeChildrenItem {
    export type Raw =
        | AstOrOperatorNodeChildrenItem.AndOperator
        | AstOrOperatorNodeChildrenItem.BooleanLiteral
        | AstOrOperatorNodeChildrenItem.DynamicVariable
        | AstOrOperatorNodeChildrenItem.EqOperator
        | AstOrOperatorNodeChildrenItem.GtOperator
        | AstOrOperatorNodeChildrenItem.GteOperator
        | AstOrOperatorNodeChildrenItem.Llm
        | AstOrOperatorNodeChildrenItem.LtOperator
        | AstOrOperatorNodeChildrenItem.LteOperator
        | AstOrOperatorNodeChildrenItem.NeqOperator
        | AstOrOperatorNodeChildrenItem.NumberLiteral
        | AstOrOperatorNodeChildrenItem.OrOperator
        | AstOrOperatorNodeChildrenItem.StringLiteral;
