...
export const SendTextVoiceSettings: core.serialization.ObjectSchema<
    serializers.SendTextVoiceSettings.Raw,
    ElevenLabs.SendTextVoiceSettings
...
export declare namespace SendTextVoiceSettings {
