...
export const GetPhoneNumberExotelResponseModel: core.serialization.ObjectSchema<
    serializers.GetPhoneNumberExotelResponseModel.Raw,
    ElevenLabs.GetPhoneNumberExotelResponseModel
...
export declare namespace GetPhoneNumberExotelResponseModel {
