...
export const AstConditionalOperatorNodeInputTrueExpression: core.serialization.Schema<
    serializers.AstConditionalOperatorNodeInputTrueExpression.Raw,
    ElevenLabs.AstConditionalOperatorNodeInputTrueExpression
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstConditionalOperatorNodeInputTrueExpression>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstConditionalOperatorNodeInputTrueExpression {
    export type Raw =
        | AstConditionalOperatorNodeInputTrueExpression.AddOperator
        | AstConditionalOperatorNodeInputTrueExpression.AndOperator
        | AstConditionalOperatorNodeInputTrueExpression.BooleanLiteral
        | AstConditionalOperatorNodeInputTrueExpression.ConditionalOperator
        | AstConditionalOperatorNodeInputTrueExpression.DivOperator
        | AstConditionalOperatorNodeInputTrueExpression.DynamicVariable
        | AstConditionalOperatorNodeInputTrueExpression.EqOperator
        | AstConditionalOperatorNodeInputTrueExpression.GtOperator
        | AstConditionalOperatorNodeInputTrueExpression.GteOperator
        | AstConditionalOperatorNodeInputTrueExpression.Llm
        | AstConditionalOperatorNodeInputTrueExpression.LtOperator
        | AstConditionalOperatorNodeInputTrueExpression.LteOperator
        | AstConditionalOperatorNodeInputTrueExpression.MulOperator
        | AstConditionalOperatorNodeInputTrueExpression.NeqOperator
        | AstConditionalOperatorNodeInputTrueExpression.NumberLiteral
        | AstConditionalOperatorNodeInputTrueExpression.OrOperator
        | AstConditionalOperatorNodeInputTrueExpression.StringLiteral
        | AstConditionalOperatorNodeInputTrueExpression.SubOperator;
