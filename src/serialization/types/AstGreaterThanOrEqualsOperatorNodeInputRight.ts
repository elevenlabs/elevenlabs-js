...
export const AstGreaterThanOrEqualsOperatorNodeInputRight: core.serialization.Schema<
    serializers.AstGreaterThanOrEqualsOperatorNodeInputRight.Raw,
    ElevenLabs.AstGreaterThanOrEqualsOperatorNodeInputRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstGreaterThanOrEqualsOperatorNodeInputRight>({
...
export declare namespace AstGreaterThanOrEqualsOperatorNodeInputRight {
    export type Raw =
        | AstGreaterThanOrEqualsOperatorNodeInputRight.AddOperator
        | AstGreaterThanOrEqualsOperatorNodeInputRight.AndOperator
        | AstGreaterThanOrEqualsOperatorNodeInputRight.BooleanLiteral
        | AstGreaterThanOrEqualsOperatorNodeInputRight.ConditionalOperator
        | AstGreaterThanOrEqualsOperatorNodeInputRight.DivOperator
        | AstGreaterThanOrEqualsOperatorNodeInputRight.DynamicVariable
        | AstGreaterThanOrEqualsOperatorNodeInputRight.EqOperator
        | AstGreaterThanOrEqualsOperatorNodeInputRight.GtOperator
        | AstGreaterThanOrEqualsOperatorNodeInputRight.GteOperator
        | AstGreaterThanOrEqualsOperatorNodeInputRight.Llm
        | AstGreaterThanOrEqualsOperatorNodeInputRight.LtOperator
        | AstGreaterThanOrEqualsOperatorNodeInputRight.LteOperator
        | AstGreaterThanOrEqualsOperatorNodeInputRight.MulOperator
        | AstGreaterThanOrEqualsOperatorNodeInputRight.NeqOperator
        | AstGreaterThanOrEqualsOperatorNodeInputRight.NumberLiteral
        | AstGreaterThanOrEqualsOperatorNodeInputRight.OrOperator
        | AstGreaterThanOrEqualsOperatorNodeInputRight.StringLiteral
        | AstGreaterThanOrEqualsOperatorNodeInputRight.SubOperator;
