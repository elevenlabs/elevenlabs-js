...
export const AstOrOperatorNodeInputChildrenItem: core.serialization.Schema<
    serializers.AstOrOperatorNodeInputChildrenItem.Raw,
    ElevenLabs.AstOrOperatorNodeInputChildrenItem
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstOrOperatorNodeInputChildrenItem>({
...
export declare namespace AstOrOperatorNodeInputChildrenItem {
    export type Raw =
        | AstOrOperatorNodeInputChildrenItem.AddOperator
        | AstOrOperatorNodeInputChildrenItem.AndOperator
        | AstOrOperatorNodeInputChildrenItem.BooleanLiteral
        | AstOrOperatorNodeInputChildrenItem.ConditionalOperator
        | AstOrOperatorNodeInputChildrenItem.DivOperator
        | AstOrOperatorNodeInputChildrenItem.DynamicVariable
        | AstOrOperatorNodeInputChildrenItem.EqOperator
        | AstOrOperatorNodeInputChildrenItem.GtOperator
        | AstOrOperatorNodeInputChildrenItem.GteOperator
        | AstOrOperatorNodeInputChildrenItem.Llm
        | AstOrOperatorNodeInputChildrenItem.LtOperator
        | AstOrOperatorNodeInputChildrenItem.LteOperator
        | AstOrOperatorNodeInputChildrenItem.MulOperator
        | AstOrOperatorNodeInputChildrenItem.NeqOperator
        | AstOrOperatorNodeInputChildrenItem.NumberLiteral
        | AstOrOperatorNodeInputChildrenItem.OrOperator
        | AstOrOperatorNodeInputChildrenItem.StringLiteral
        | AstOrOperatorNodeInputChildrenItem.SubOperator;
