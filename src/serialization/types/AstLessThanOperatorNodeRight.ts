...
export const AstLessThanOperatorNodeRight: core.serialization.Schema<
    serializers.AstLessThanOperatorNodeRight.Raw,
    ElevenLabs.AstLessThanOperatorNodeRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstLessThanOperatorNodeRight>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstLessThanOperatorNodeRight {
    export type Raw =
        | AstLessThanOperatorNodeRight.AndOperator
        | AstLessThanOperatorNodeRight.BooleanLiteral
        | AstLessThanOperatorNodeRight.DynamicVariable
        | AstLessThanOperatorNodeRight.EqOperator
        | AstLessThanOperatorNodeRight.GtOperator
        | AstLessThanOperatorNodeRight.GteOperator
        | AstLessThanOperatorNodeRight.Llm
        | AstLessThanOperatorNodeRight.LtOperator
        | AstLessThanOperatorNodeRight.LteOperator
        | AstLessThanOperatorNodeRight.NeqOperator
        | AstLessThanOperatorNodeRight.NumberLiteral
        | AstLessThanOperatorNodeRight.OrOperator
        | AstLessThanOperatorNodeRight.StringLiteral;
