...
export const AstDivisionOperatorNodeOutputRight: core.serialization.Schema<
    serializers.AstDivisionOperatorNodeOutputRight.Raw,
    ElevenLabs.AstDivisionOperatorNodeOutputRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstDivisionOperatorNodeOutputRight>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstDivisionOperatorNodeOutputRight {
    export type Raw =
        | AstDivisionOperatorNodeOutputRight.AddOperator
        | AstDivisionOperatorNodeOutputRight.AndOperator
        | AstDivisionOperatorNodeOutputRight.BooleanLiteral
        | AstDivisionOperatorNodeOutputRight.ConditionalOperator
        | AstDivisionOperatorNodeOutputRight.DivOperator
        | AstDivisionOperatorNodeOutputRight.DynamicVariable
        | AstDivisionOperatorNodeOutputRight.EqOperator
        | AstDivisionOperatorNodeOutputRight.GtOperator
        | AstDivisionOperatorNodeOutputRight.GteOperator
        | AstDivisionOperatorNodeOutputRight.Llm
        | AstDivisionOperatorNodeOutputRight.LtOperator
        | AstDivisionOperatorNodeOutputRight.LteOperator
        | AstDivisionOperatorNodeOutputRight.MulOperator
        | AstDivisionOperatorNodeOutputRight.NeqOperator
        | AstDivisionOperatorNodeOutputRight.NumberLiteral
        | AstDivisionOperatorNodeOutputRight.OrOperator
        | AstDivisionOperatorNodeOutputRight.StringLiteral
        | AstDivisionOperatorNodeOutputRight.SubOperator;
