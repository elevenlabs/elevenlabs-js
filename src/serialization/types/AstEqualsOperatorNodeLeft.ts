...
export const AstEqualsOperatorNodeLeft: core.serialization.Schema<
    serializers.AstEqualsOperatorNodeLeft.Raw,
    ElevenLabs.AstEqualsOperatorNodeLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstEqualsOperatorNodeLeft>({
...
export declare namespace AstEqualsOperatorNodeLeft {
    export type Raw =
        | AstEqualsOperatorNodeLeft.AndOperator
        | AstEqualsOperatorNodeLeft.BooleanLiteral
        | AstEqualsOperatorNodeLeft.DynamicVariable
        | AstEqualsOperatorNodeLeft.EqOperator
        | AstEqualsOperatorNodeLeft.GtOperator
        | AstEqualsOperatorNodeLeft.GteOperator
        | AstEqualsOperatorNodeLeft.Llm
        | AstEqualsOperatorNodeLeft.LtOperator
        | AstEqualsOperatorNodeLeft.LteOperator
        | AstEqualsOperatorNodeLeft.NeqOperator
        | AstEqualsOperatorNodeLeft.NumberLiteral
        | AstEqualsOperatorNodeLeft.OrOperator
        | AstEqualsOperatorNodeLeft.StringLiteral;
