...
export const AstMultiplicationOperatorNodeOutputLeft: core.serialization.Schema<
    serializers.AstMultiplicationOperatorNodeOutputLeft.Raw,
    ElevenLabs.AstMultiplicationOperatorNodeOutputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstMultiplicationOperatorNodeOutputLeft>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstMultiplicationOperatorNodeOutputLeft {
    export type Raw =
        | AstMultiplicationOperatorNodeOutputLeft.AddOperator
        | AstMultiplicationOperatorNodeOutputLeft.AndOperator
        | AstMultiplicationOperatorNodeOutputLeft.BooleanLiteral
        | AstMultiplicationOperatorNodeOutputLeft.ConditionalOperator
        | AstMultiplicationOperatorNodeOutputLeft.DivOperator
        | AstMultiplicationOperatorNodeOutputLeft.DynamicVariable
        | AstMultiplicationOperatorNodeOutputLeft.EqOperator
        | AstMultiplicationOperatorNodeOutputLeft.GtOperator
        | AstMultiplicationOperatorNodeOutputLeft.GteOperator
        | AstMultiplicationOperatorNodeOutputLeft.Llm
        | AstMultiplicationOperatorNodeOutputLeft.LtOperator
        | AstMultiplicationOperatorNodeOutputLeft.LteOperator
        | AstMultiplicationOperatorNodeOutputLeft.MulOperator
        | AstMultiplicationOperatorNodeOutputLeft.NeqOperator
        | AstMultiplicationOperatorNodeOutputLeft.NumberLiteral
        | AstMultiplicationOperatorNodeOutputLeft.OrOperator
        | AstMultiplicationOperatorNodeOutputLeft.StringLiteral
        | AstMultiplicationOperatorNodeOutputLeft.SubOperator;
