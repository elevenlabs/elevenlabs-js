...
export const AstGreaterThanOperatorNodeInputLeft: core.serialization.Schema<
    serializers.AstGreaterThanOperatorNodeInputLeft.Raw,
    ElevenLabs.AstGreaterThanOperatorNodeInputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstGreaterThanOperatorNodeInputLeft>({
...
export declare namespace AstGreaterThanOperatorNodeInputLeft {
    export type Raw =
        | AstGreaterThanOperatorNodeInputLeft.AddOperator
        | AstGreaterThanOperatorNodeInputLeft.AndOperator
        | AstGreaterThanOperatorNodeInputLeft.BooleanLiteral
        | AstGreaterThanOperatorNodeInputLeft.ConditionalOperator
        | AstGreaterThanOperatorNodeInputLeft.DivOperator
        | AstGreaterThanOperatorNodeInputLeft.DynamicVariable
        | AstGreaterThanOperatorNodeInputLeft.EqOperator
        | AstGreaterThanOperatorNodeInputLeft.GtOperator
        | AstGreaterThanOperatorNodeInputLeft.GteOperator
        | AstGreaterThanOperatorNodeInputLeft.Llm
        | AstGreaterThanOperatorNodeInputLeft.LtOperator
        | AstGreaterThanOperatorNodeInputLeft.LteOperator
        | AstGreaterThanOperatorNodeInputLeft.MulOperator
        | AstGreaterThanOperatorNodeInputLeft.NeqOperator
        | AstGreaterThanOperatorNodeInputLeft.NumberLiteral
        | AstGreaterThanOperatorNodeInputLeft.OrOperator
        | AstGreaterThanOperatorNodeInputLeft.StringLiteral
        | AstGreaterThanOperatorNodeInputLeft.SubOperator;
