...
export const WorkflowExpressionConditionModelOutputExpression: core.serialization.Schema<
    serializers.WorkflowExpressionConditionModelOutputExpression.Raw,
    ElevenLabs.WorkflowExpressionConditionModelOutputExpression
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.WorkflowExpressionConditionModelOutputExpression>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace WorkflowExpressionConditionModelOutputExpression {
    export type Raw =
        | WorkflowExpressionConditionModelOutputExpression.AddOperator
        | WorkflowExpressionConditionModelOutputExpression.AndOperator
        | WorkflowExpressionConditionModelOutputExpression.BooleanLiteral
        | WorkflowExpressionConditionModelOutputExpression.ConditionalOperator
        | WorkflowExpressionConditionModelOutputExpression.DivOperator
        | WorkflowExpressionConditionModelOutputExpression.DynamicVariable
        | WorkflowExpressionConditionModelOutputExpression.EqOperator
        | WorkflowExpressionConditionModelOutputExpression.GtOperator
        | WorkflowExpressionConditionModelOutputExpression.GteOperator
        | WorkflowExpressionConditionModelOutputExpression.Llm
        | WorkflowExpressionConditionModelOutputExpression.LtOperator
        | WorkflowExpressionConditionModelOutputExpression.LteOperator
        | WorkflowExpressionConditionModelOutputExpression.MulOperator
        | WorkflowExpressionConditionModelOutputExpression.NeqOperator
        | WorkflowExpressionConditionModelOutputExpression.NumberLiteral
        | WorkflowExpressionConditionModelOutputExpression.OrOperator
        | WorkflowExpressionConditionModelOutputExpression.StringLiteral
        | WorkflowExpressionConditionModelOutputExpression.SubOperator;
