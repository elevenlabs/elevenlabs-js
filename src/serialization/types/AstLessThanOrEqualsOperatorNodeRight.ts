...
export const AstLessThanOrEqualsOperatorNodeRight: core.serialization.Schema<
    serializers.AstLessThanOrEqualsOperatorNodeRight.Raw,
    ElevenLabs.AstLessThanOrEqualsOperatorNodeRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstLessThanOrEqualsOperatorNodeRight>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstLessThanOrEqualsOperatorNodeRight {
    export type Raw =
        | AstLessThanOrEqualsOperatorNodeRight.AndOperator
        | AstLessThanOrEqualsOperatorNodeRight.BooleanLiteral
        | AstLessThanOrEqualsOperatorNodeRight.DynamicVariable
        | AstLessThanOrEqualsOperatorNodeRight.EqOperator
        | AstLessThanOrEqualsOperatorNodeRight.GtOperator
        | AstLessThanOrEqualsOperatorNodeRight.GteOperator
        | AstLessThanOrEqualsOperatorNodeRight.Llm
        | AstLessThanOrEqualsOperatorNodeRight.LtOperator
        | AstLessThanOrEqualsOperatorNodeRight.LteOperator
        | AstLessThanOrEqualsOperatorNodeRight.NeqOperator
        | AstLessThanOrEqualsOperatorNodeRight.NumberLiteral
        | AstLessThanOrEqualsOperatorNodeRight.OrOperator
        | AstLessThanOrEqualsOperatorNodeRight.StringLiteral;
