...
export const AstLessThanOrEqualsOperatorNodeOutputRight: core.serialization.Schema<
    serializers.AstLessThanOrEqualsOperatorNodeOutputRight.Raw,
    ElevenLabs.AstLessThanOrEqualsOperatorNodeOutputRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstLessThanOrEqualsOperatorNodeOutputRight>({
...
export declare namespace AstLessThanOrEqualsOperatorNodeOutputRight {
    export type Raw =
        | AstLessThanOrEqualsOperatorNodeOutputRight.AddOperator
        | AstLessThanOrEqualsOperatorNodeOutputRight.AndOperator
        | AstLessThanOrEqualsOperatorNodeOutputRight.BooleanLiteral
        | AstLessThanOrEqualsOperatorNodeOutputRight.ConditionalOperator
        | AstLessThanOrEqualsOperatorNodeOutputRight.DivOperator
        | AstLessThanOrEqualsOperatorNodeOutputRight.DynamicVariable
        | AstLessThanOrEqualsOperatorNodeOutputRight.EqOperator
        | AstLessThanOrEqualsOperatorNodeOutputRight.GtOperator
        | AstLessThanOrEqualsOperatorNodeOutputRight.GteOperator
        | AstLessThanOrEqualsOperatorNodeOutputRight.Llm
        | AstLessThanOrEqualsOperatorNodeOutputRight.LtOperator
        | AstLessThanOrEqualsOperatorNodeOutputRight.LteOperator
        | AstLessThanOrEqualsOperatorNodeOutputRight.MulOperator
        | AstLessThanOrEqualsOperatorNodeOutputRight.NeqOperator
        | AstLessThanOrEqualsOperatorNodeOutputRight.NumberLiteral
        | AstLessThanOrEqualsOperatorNodeOutputRight.OrOperator
        | AstLessThanOrEqualsOperatorNodeOutputRight.StringLiteral
        | AstLessThanOrEqualsOperatorNodeOutputRight.SubOperator;
