...
import { TransferToAgentToolResultSuccessModelOutputBranchInfo } from "./TransferToAgentToolResultSuccessModelOutputBranchInfo.js";

export const TransferToAgentToolResultSuccessModelOutput: core.serialization.ObjectSchema<
    serializers.TransferToAgentToolResultSuccessModelOutput.Raw,
    ElevenLabs.TransferToAgentToolResultSuccessModelOutput
> = core.serialization.object({
    ...
    branchInfo: core.serialization.property(
        "branch_info",
        TransferToAgentToolResultSuccessModelOutputBranchInfo.optional(),
    ),
