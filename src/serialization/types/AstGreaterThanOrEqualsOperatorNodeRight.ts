...
export const AstGreaterThanOrEqualsOperatorNodeRight: core.serialization.Schema<
    serializers.AstGreaterThanOrEqualsOperatorNodeRight.Raw,
...
> = core.serialization
    ...
    .transform<ElevenLabs.AstGreaterThanOrEqualsOperatorNodeRight>({
...
export declare namespace AstGreaterThanOrEqualsOperatorNodeRight {
    export type Raw =
        | AstGreaterThanOrEqualsOperatorNodeRight.AndOperator
        | AstGreaterThanOrEqualsOperatorNodeRight.BooleanLiteral
        | AstGreaterThanOrEqualsOperatorNodeRight.DynamicVariable
        | AstGreaterThanOrEqualsOperatorNodeRight.EqOperator
        | AstGreaterThanOrEqualsOperatorNodeRight.GtOperator
        | AstGreaterThanOrEqualsOperatorNodeRight.GteOperator
        | AstGreaterThanOrEqualsOperatorNodeRight.Llm
        | AstGreaterThanOrEqualsOperatorNodeRight.LtOperator
        | AstGreaterThanOrEqualsOperatorNodeRight.LteOperator
        | AstGreaterThanOrEqualsOperatorNodeRight.NeqOperator
        | AstGreaterThanOrEqualsOperatorNodeRight.NumberLiteral
        | AstGreaterThanOrEqualsOperatorNodeRight.OrOperator
        | AstGreaterThanOrEqualsOperatorNodeRight.StringLiteral;
