...
export const AstConditionalOperatorNodeOutputTrueExpression: core.serialization.Schema<
    serializers.AstConditionalOperatorNodeOutputTrueExpression.Raw,
    ElevenLabs.AstConditionalOperatorNodeOutputTrueExpression
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstConditionalOperatorNodeOutputTrueExpression>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstConditionalOperatorNodeOutputTrueExpression {
    export type Raw =
        | AstConditionalOperatorNodeOutputTrueExpression.AddOperator
        | AstConditionalOperatorNodeOutputTrueExpression.AndOperator
        | AstConditionalOperatorNodeOutputTrueExpression.BooleanLiteral
        | AstConditionalOperatorNodeOutputTrueExpression.ConditionalOperator
        | AstConditionalOperatorNodeOutputTrueExpression.DivOperator
        | AstConditionalOperatorNodeOutputTrueExpression.DynamicVariable
        | AstConditionalOperatorNodeOutputTrueExpression.EqOperator
        | AstConditionalOperatorNodeOutputTrueExpression.GtOperator
        | AstConditionalOperatorNodeOutputTrueExpression.GteOperator
        | AstConditionalOperatorNodeOutputTrueExpression.Llm
        | AstConditionalOperatorNodeOutputTrueExpression.LtOperator
        | AstConditionalOperatorNodeOutputTrueExpression.LteOperator
        | AstConditionalOperatorNodeOutputTrueExpression.MulOperator
        | AstConditionalOperatorNodeOutputTrueExpression.NeqOperator
        | AstConditionalOperatorNodeOutputTrueExpression.NumberLiteral
        | AstConditionalOperatorNodeOutputTrueExpression.OrOperator
        | AstConditionalOperatorNodeOutputTrueExpression.StringLiteral
        | AstConditionalOperatorNodeOutputTrueExpression.SubOperator;
