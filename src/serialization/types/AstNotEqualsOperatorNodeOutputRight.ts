...
export const AstNotEqualsOperatorNodeOutputRight: core.serialization.Schema<
    serializers.AstNotEqualsOperatorNodeOutputRight.Raw,
    ElevenLabs.AstNotEqualsOperatorNodeOutputRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstNotEqualsOperatorNodeOutputRight>({
...
export declare namespace AstNotEqualsOperatorNodeOutputRight {
    export type Raw =
        | AstNotEqualsOperatorNodeOutputRight.AddOperator
        | AstNotEqualsOperatorNodeOutputRight.AndOperator
        | AstNotEqualsOperatorNodeOutputRight.BooleanLiteral
        | AstNotEqualsOperatorNodeOutputRight.ConditionalOperator
        | AstNotEqualsOperatorNodeOutputRight.DivOperator
        | AstNotEqualsOperatorNodeOutputRight.DynamicVariable
        | AstNotEqualsOperatorNodeOutputRight.EqOperator
        | AstNotEqualsOperatorNodeOutputRight.GtOperator
        | AstNotEqualsOperatorNodeOutputRight.GteOperator
        | AstNotEqualsOperatorNodeOutputRight.Llm
        | AstNotEqualsOperatorNodeOutputRight.LtOperator
        | AstNotEqualsOperatorNodeOutputRight.LteOperator
        | AstNotEqualsOperatorNodeOutputRight.MulOperator
        | AstNotEqualsOperatorNodeOutputRight.NeqOperator
        | AstNotEqualsOperatorNodeOutputRight.NumberLiteral
        | AstNotEqualsOperatorNodeOutputRight.OrOperator
        | AstNotEqualsOperatorNodeOutputRight.StringLiteral
        | AstNotEqualsOperatorNodeOutputRight.SubOperator;
