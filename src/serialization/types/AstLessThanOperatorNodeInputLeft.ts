...
export const AstLessThanOperatorNodeInputLeft: core.serialization.Schema<
    serializers.AstLessThanOperatorNodeInputLeft.Raw,
    ElevenLabs.AstLessThanOperatorNodeInputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstLessThanOperatorNodeInputLeft>({
...
export declare namespace AstLessThanOperatorNodeInputLeft {
    export type Raw =
        | AstLessThanOperatorNodeInputLeft.AddOperator
        | AstLessThanOperatorNodeInputLeft.AndOperator
        | AstLessThanOperatorNodeInputLeft.BooleanLiteral
        | AstLessThanOperatorNodeInputLeft.ConditionalOperator
        | AstLessThanOperatorNodeInputLeft.DivOperator
        | AstLessThanOperatorNodeInputLeft.DynamicVariable
        | AstLessThanOperatorNodeInputLeft.EqOperator
        | AstLessThanOperatorNodeInputLeft.GtOperator
        | AstLessThanOperatorNodeInputLeft.GteOperator
        | AstLessThanOperatorNodeInputLeft.Llm
        | AstLessThanOperatorNodeInputLeft.LtOperator
        | AstLessThanOperatorNodeInputLeft.LteOperator
        | AstLessThanOperatorNodeInputLeft.MulOperator
        | AstLessThanOperatorNodeInputLeft.NeqOperator
        | AstLessThanOperatorNodeInputLeft.NumberLiteral
        | AstLessThanOperatorNodeInputLeft.OrOperator
        | AstLessThanOperatorNodeInputLeft.StringLiteral
        | AstLessThanOperatorNodeInputLeft.SubOperator;
