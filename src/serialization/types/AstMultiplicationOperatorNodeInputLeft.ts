...
export const AstMultiplicationOperatorNodeInputLeft: core.serialization.Schema<
    serializers.AstMultiplicationOperatorNodeInputLeft.Raw,
    ElevenLabs.AstMultiplicationOperatorNodeInputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstMultiplicationOperatorNodeInputLeft>({
...
export declare namespace AstMultiplicationOperatorNodeInputLeft {
    export type Raw =
        | AstMultiplicationOperatorNodeInputLeft.AddOperator
        | AstMultiplicationOperatorNodeInputLeft.AndOperator
        | AstMultiplicationOperatorNodeInputLeft.BooleanLiteral
        | AstMultiplicationOperatorNodeInputLeft.ConditionalOperator
        | AstMultiplicationOperatorNodeInputLeft.DivOperator
        | AstMultiplicationOperatorNodeInputLeft.DynamicVariable
        | AstMultiplicationOperatorNodeInputLeft.EqOperator
        | AstMultiplicationOperatorNodeInputLeft.GtOperator
        | AstMultiplicationOperatorNodeInputLeft.GteOperator
        | AstMultiplicationOperatorNodeInputLeft.Llm
        | AstMultiplicationOperatorNodeInputLeft.LtOperator
        | AstMultiplicationOperatorNodeInputLeft.LteOperator
        | AstMultiplicationOperatorNodeInputLeft.MulOperator
        | AstMultiplicationOperatorNodeInputLeft.NeqOperator
        | AstMultiplicationOperatorNodeInputLeft.NumberLiteral
        | AstMultiplicationOperatorNodeInputLeft.OrOperator
        | AstMultiplicationOperatorNodeInputLeft.StringLiteral
        | AstMultiplicationOperatorNodeInputLeft.SubOperator;
