...
export const AstConditionalOperatorNodeOutputCondition: core.serialization.Schema<
    serializers.AstConditionalOperatorNodeOutputCondition.Raw,
    ElevenLabs.AstConditionalOperatorNodeOutputCondition
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstConditionalOperatorNodeOutputCondition>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstConditionalOperatorNodeOutputCondition {
    export type Raw =
        | AstConditionalOperatorNodeOutputCondition.AddOperator
        | AstConditionalOperatorNodeOutputCondition.AndOperator
        | AstConditionalOperatorNodeOutputCondition.BooleanLiteral
        | AstConditionalOperatorNodeOutputCondition.ConditionalOperator
        | AstConditionalOperatorNodeOutputCondition.DivOperator
        | AstConditionalOperatorNodeOutputCondition.DynamicVariable
        | AstConditionalOperatorNodeOutputCondition.EqOperator
        | AstConditionalOperatorNodeOutputCondition.GtOperator
        | AstConditionalOperatorNodeOutputCondition.GteOperator
        | AstConditionalOperatorNodeOutputCondition.Llm
        | AstConditionalOperatorNodeOutputCondition.LtOperator
        | AstConditionalOperatorNodeOutputCondition.LteOperator
        | AstConditionalOperatorNodeOutputCondition.MulOperator
        | AstConditionalOperatorNodeOutputCondition.NeqOperator
        | AstConditionalOperatorNodeOutputCondition.NumberLiteral
        | AstConditionalOperatorNodeOutputCondition.OrOperator
        | AstConditionalOperatorNodeOutputCondition.StringLiteral
        | AstConditionalOperatorNodeOutputCondition.SubOperator;
