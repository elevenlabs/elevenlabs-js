...
export const WorkflowExpressionConditionModelInputExpression: core.serialization.Schema<
    serializers.WorkflowExpressionConditionModelInputExpression.Raw,
    ElevenLabs.WorkflowExpressionConditionModelInputExpression
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.WorkflowExpressionConditionModelInputExpression>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace WorkflowExpressionConditionModelInputExpression {
    export type Raw =
        | WorkflowExpressionConditionModelInputExpression.AddOperator
        | WorkflowExpressionConditionModelInputExpression.AndOperator
        | WorkflowExpressionConditionModelInputExpression.BooleanLiteral
        | WorkflowExpressionConditionModelInputExpression.ConditionalOperator
        | WorkflowExpressionConditionModelInputExpression.DivOperator
        | WorkflowExpressionConditionModelInputExpression.DynamicVariable
        | WorkflowExpressionConditionModelInputExpression.EqOperator
        | WorkflowExpressionConditionModelInputExpression.GtOperator
        | WorkflowExpressionConditionModelInputExpression.GteOperator
        | WorkflowExpressionConditionModelInputExpression.Llm
        | WorkflowExpressionConditionModelInputExpression.LtOperator
        | WorkflowExpressionConditionModelInputExpression.LteOperator
        | WorkflowExpressionConditionModelInputExpression.MulOperator
        | WorkflowExpressionConditionModelInputExpression.NeqOperator
        | WorkflowExpressionConditionModelInputExpression.NumberLiteral
        | WorkflowExpressionConditionModelInputExpression.OrOperator
        | WorkflowExpressionConditionModelInputExpression.StringLiteral
        | WorkflowExpressionConditionModelInputExpression.SubOperator;
