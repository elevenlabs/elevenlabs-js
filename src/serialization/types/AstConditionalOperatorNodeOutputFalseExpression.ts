...
export const AstConditionalOperatorNodeOutputFalseExpression: core.serialization.Schema<
    serializers.AstConditionalOperatorNodeOutputFalseExpression.Raw,
    ElevenLabs.AstConditionalOperatorNodeOutputFalseExpression
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstConditionalOperatorNodeOutputFalseExpression>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstConditionalOperatorNodeOutputFalseExpression {
    export type Raw =
        | AstConditionalOperatorNodeOutputFalseExpression.AddOperator
        | AstConditionalOperatorNodeOutputFalseExpression.AndOperator
        | AstConditionalOperatorNodeOutputFalseExpression.BooleanLiteral
        | AstConditionalOperatorNodeOutputFalseExpression.ConditionalOperator
        | AstConditionalOperatorNodeOutputFalseExpression.DivOperator
        | AstConditionalOperatorNodeOutputFalseExpression.DynamicVariable
        | AstConditionalOperatorNodeOutputFalseExpression.EqOperator
        | AstConditionalOperatorNodeOutputFalseExpression.GtOperator
        | AstConditionalOperatorNodeOutputFalseExpression.GteOperator
        | AstConditionalOperatorNodeOutputFalseExpression.Llm
        | AstConditionalOperatorNodeOutputFalseExpression.LtOperator
        | AstConditionalOperatorNodeOutputFalseExpression.LteOperator
        | AstConditionalOperatorNodeOutputFalseExpression.MulOperator
        | AstConditionalOperatorNodeOutputFalseExpression.NeqOperator
        | AstConditionalOperatorNodeOutputFalseExpression.NumberLiteral
        | AstConditionalOperatorNodeOutputFalseExpression.OrOperator
        | AstConditionalOperatorNodeOutputFalseExpression.StringLiteral
        | AstConditionalOperatorNodeOutputFalseExpression.SubOperator;
