...
export const AstGreaterThanOperatorNodeLeft: core.serialization.Schema<
    serializers.AstGreaterThanOperatorNodeLeft.Raw,
    ElevenLabs.AstGreaterThanOperatorNodeLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstGreaterThanOperatorNodeLeft>({
...
export declare namespace AstGreaterThanOperatorNodeLeft {
    export type Raw =
        | AstGreaterThanOperatorNodeLeft.AndOperator
        | AstGreaterThanOperatorNodeLeft.BooleanLiteral
        | AstGreaterThanOperatorNodeLeft.DynamicVariable
        | AstGreaterThanOperatorNodeLeft.EqOperator
        | AstGreaterThanOperatorNodeLeft.GtOperator
        | AstGreaterThanOperatorNodeLeft.GteOperator
        | AstGreaterThanOperatorNodeLeft.Llm
        | AstGreaterThanOperatorNodeLeft.LtOperator
        | AstGreaterThanOperatorNodeLeft.LteOperator
        | AstGreaterThanOperatorNodeLeft.NeqOperator
        | AstGreaterThanOperatorNodeLeft.NumberLiteral
        | AstGreaterThanOperatorNodeLeft.OrOperator
        | AstGreaterThanOperatorNodeLeft.StringLiteral;
