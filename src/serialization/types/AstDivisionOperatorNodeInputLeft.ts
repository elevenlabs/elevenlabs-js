...
export const AstDivisionOperatorNodeInputLeft: core.serialization.Schema<
    serializers.AstDivisionOperatorNodeInputLeft.Raw,
    ElevenLabs.AstDivisionOperatorNodeInputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstDivisionOperatorNodeInputLeft>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstDivisionOperatorNodeInputLeft {
    export type Raw =
        | AstDivisionOperatorNodeInputLeft.AddOperator
        | AstDivisionOperatorNodeInputLeft.AndOperator
        | AstDivisionOperatorNodeInputLeft.BooleanLiteral
        | AstDivisionOperatorNodeInputLeft.ConditionalOperator
        | AstDivisionOperatorNodeInputLeft.DivOperator
        | AstDivisionOperatorNodeInputLeft.DynamicVariable
        | AstDivisionOperatorNodeInputLeft.EqOperator
        | AstDivisionOperatorNodeInputLeft.GtOperator
        | AstDivisionOperatorNodeInputLeft.GteOperator
        | AstDivisionOperatorNodeInputLeft.Llm
        | AstDivisionOperatorNodeInputLeft.LtOperator
        | AstDivisionOperatorNodeInputLeft.LteOperator
        | AstDivisionOperatorNodeInputLeft.MulOperator
        | AstDivisionOperatorNodeInputLeft.NeqOperator
        | AstDivisionOperatorNodeInputLeft.NumberLiteral
        | AstDivisionOperatorNodeInputLeft.OrOperator
        | AstDivisionOperatorNodeInputLeft.StringLiteral
        | AstDivisionOperatorNodeInputLeft.SubOperator;
