...
export const AstLessThanOrEqualsOperatorNodeInputRight: core.serialization.Schema<
    serializers.AstLessThanOrEqualsOperatorNodeInputRight.Raw,
    ElevenLabs.AstLessThanOrEqualsOperatorNodeInputRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstLessThanOrEqualsOperatorNodeInputRight>({
...
export declare namespace AstLessThanOrEqualsOperatorNodeInputRight {
    export type Raw =
        | AstLessThanOrEqualsOperatorNodeInputRight.AddOperator
        | AstLessThanOrEqualsOperatorNodeInputRight.AndOperator
        | AstLessThanOrEqualsOperatorNodeInputRight.BooleanLiteral
        | AstLessThanOrEqualsOperatorNodeInputRight.ConditionalOperator
        | AstLessThanOrEqualsOperatorNodeInputRight.DivOperator
        | AstLessThanOrEqualsOperatorNodeInputRight.DynamicVariable
        | AstLessThanOrEqualsOperatorNodeInputRight.EqOperator
        | AstLessThanOrEqualsOperatorNodeInputRight.GtOperator
        | AstLessThanOrEqualsOperatorNodeInputRight.GteOperator
        | AstLessThanOrEqualsOperatorNodeInputRight.Llm
        | AstLessThanOrEqualsOperatorNodeInputRight.LtOperator
        | AstLessThanOrEqualsOperatorNodeInputRight.LteOperator
        | AstLessThanOrEqualsOperatorNodeInputRight.MulOperator
        | AstLessThanOrEqualsOperatorNodeInputRight.NeqOperator
        | AstLessThanOrEqualsOperatorNodeInputRight.NumberLiteral
        | AstLessThanOrEqualsOperatorNodeInputRight.OrOperator
        | AstLessThanOrEqualsOperatorNodeInputRight.StringLiteral
        | AstLessThanOrEqualsOperatorNodeInputRight.SubOperator;
