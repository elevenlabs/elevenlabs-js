...
export const AstGreaterThanOrEqualsOperatorNodeOutputRight: core.serialization.Schema<
    serializers.AstGreaterThanOrEqualsOperatorNodeOutputRight.Raw,
    ElevenLabs.AstGreaterThanOrEqualsOperatorNodeOutputRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstGreaterThanOrEqualsOperatorNodeOutputRight>({
...
export declare namespace AstGreaterThanOrEqualsOperatorNodeOutputRight {
    export type Raw =
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.AddOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.AndOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.BooleanLiteral
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.ConditionalOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.DivOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.DynamicVariable
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.EqOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.GtOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.GteOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.Llm
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.LtOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.LteOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.MulOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.NeqOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.NumberLiteral
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.OrOperator
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.StringLiteral
        | AstGreaterThanOrEqualsOperatorNodeOutputRight.SubOperator;
