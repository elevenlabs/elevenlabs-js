...
export const PromptAgentApiModelOverrideOutput: core.serialization.ObjectSchema<
    serializers.PromptAgentApiModelOverrideOutput.Raw,
    ElevenLabs.PromptAgentApiModelOverrideOutput
