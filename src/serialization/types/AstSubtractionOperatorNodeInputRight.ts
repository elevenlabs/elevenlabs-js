...
export const AstSubtractionOperatorNodeInputRight: core.serialization.Schema<
    serializers.AstSubtractionOperatorNodeInputRight.Raw,
    ElevenLabs.AstSubtractionOperatorNodeInputRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstSubtractionOperatorNodeInputRight>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstSubtractionOperatorNodeInputRight {
    export type Raw =
        | AstSubtractionOperatorNodeInputRight.AddOperator
        | AstSubtractionOperatorNodeInputRight.AndOperator
        | AstSubtractionOperatorNodeInputRight.BooleanLiteral
        | AstSubtractionOperatorNodeInputRight.ConditionalOperator
        | AstSubtractionOperatorNodeInputRight.DivOperator
        | AstSubtractionOperatorNodeInputRight.DynamicVariable
        | AstSubtractionOperatorNodeInputRight.EqOperator
        | AstSubtractionOperatorNodeInputRight.GtOperator
        | AstSubtractionOperatorNodeInputRight.GteOperator
        | AstSubtractionOperatorNodeInputRight.Llm
        | AstSubtractionOperatorNodeInputRight.LtOperator
        | AstSubtractionOperatorNodeInputRight.LteOperator
        | AstSubtractionOperatorNodeInputRight.MulOperator
        | AstSubtractionOperatorNodeInputRight.NeqOperator
        | AstSubtractionOperatorNodeInputRight.NumberLiteral
        | AstSubtractionOperatorNodeInputRight.OrOperator
        | AstSubtractionOperatorNodeInputRight.StringLiteral
        | AstSubtractionOperatorNodeInputRight.SubOperator;
