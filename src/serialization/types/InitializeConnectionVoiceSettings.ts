...
export const InitializeConnectionVoiceSettings: core.serialization.ObjectSchema<
    serializers.InitializeConnectionVoiceSettings.Raw,
    ElevenLabs.InitializeConnectionVoiceSettings
...
export declare namespace InitializeConnectionVoiceSettings {
