...
export const ConversationHistoryTranscriptToolResultCommonModel: core.serialization.ObjectSchema<
    serializers.ConversationHistoryTranscriptToolResultCommonModel.Raw,
    ElevenLabs.ConversationHistoryTranscriptToolResultCommonModel
...
export declare namespace ConversationHistoryTranscriptToolResultCommonModel {
