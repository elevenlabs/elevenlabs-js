...
export const AstAndOperatorNodeChildrenItem: core.serialization.Schema<
    serializers.AstAndOperatorNodeChildrenItem.Raw,
    ElevenLabs.AstAndOperatorNodeChildrenItem
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstAndOperatorNodeChildrenItem>({
...
export declare namespace AstAndOperatorNodeChildrenItem {
    export type Raw =
        | AstAndOperatorNodeChildrenItem.AndOperator
        | AstAndOperatorNodeChildrenItem.BooleanLiteral
        | AstAndOperatorNodeChildrenItem.DynamicVariable
        | AstAndOperatorNodeChildrenItem.EqOperator
        | AstAndOperatorNodeChildrenItem.GtOperator
        | AstAndOperatorNodeChildrenItem.GteOperator
        | AstAndOperatorNodeChildrenItem.Llm
        | AstAndOperatorNodeChildrenItem.LtOperator
        | AstAndOperatorNodeChildrenItem.LteOperator
        | AstAndOperatorNodeChildrenItem.NeqOperator
        | AstAndOperatorNodeChildrenItem.NumberLiteral
        | AstAndOperatorNodeChildrenItem.OrOperator
        | AstAndOperatorNodeChildrenItem.StringLiteral;
