...
export const AstGreaterThanOperatorNodeRight: core.serialization.Schema<
    serializers.AstGreaterThanOperatorNodeRight.Raw,
    ElevenLabs.AstGreaterThanOperatorNodeRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstGreaterThanOperatorNodeRight>({
...
export declare namespace AstGreaterThanOperatorNodeRight {
    export type Raw =
        | AstGreaterThanOperatorNodeRight.AndOperator
        | AstGreaterThanOperatorNodeRight.BooleanLiteral
        | AstGreaterThanOperatorNodeRight.DynamicVariable
        | AstGreaterThanOperatorNodeRight.EqOperator
        | AstGreaterThanOperatorNodeRight.GtOperator
        | AstGreaterThanOperatorNodeRight.GteOperator
        | AstGreaterThanOperatorNodeRight.Llm
        | AstGreaterThanOperatorNodeRight.LtOperator
        | AstGreaterThanOperatorNodeRight.LteOperator
        | AstGreaterThanOperatorNodeRight.NeqOperator
        | AstGreaterThanOperatorNodeRight.NumberLiteral
        | AstGreaterThanOperatorNodeRight.OrOperator
        | AstGreaterThanOperatorNodeRight.StringLiteral;
