...
export const WorkflowExpressionConditionModelExpression: core.serialization.Schema<
    serializers.WorkflowExpressionConditionModelExpression.Raw,
    ElevenLabs.WorkflowExpressionConditionModelExpression
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.WorkflowExpressionConditionModelExpression>({
...
export declare namespace WorkflowExpressionConditionModelExpression {
    export type Raw =
        | WorkflowExpressionConditionModelExpression.AndOperator
        | WorkflowExpressionConditionModelExpression.BooleanLiteral
        | WorkflowExpressionConditionModelExpression.DynamicVariable
        | WorkflowExpressionConditionModelExpression.EqOperator
        | WorkflowExpressionConditionModelExpression.GtOperator
        | WorkflowExpressionConditionModelExpression.GteOperator
        | WorkflowExpressionConditionModelExpression.Llm
        | WorkflowExpressionConditionModelExpression.LtOperator
        | WorkflowExpressionConditionModelExpression.LteOperator
        | WorkflowExpressionConditionModelExpression.NeqOperator
        | WorkflowExpressionConditionModelExpression.NumberLiteral
        | WorkflowExpressionConditionModelExpression.OrOperator
        | WorkflowExpressionConditionModelExpression.StringLiteral;
