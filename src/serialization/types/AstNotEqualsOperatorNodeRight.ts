...
export const AstNotEqualsOperatorNodeRight: core.serialization.Schema<
    serializers.AstNotEqualsOperatorNodeRight.Raw,
    ElevenLabs.AstNotEqualsOperatorNodeRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstNotEqualsOperatorNodeRight>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstNotEqualsOperatorNodeRight {
    export type Raw =
        | AstNotEqualsOperatorNodeRight.AndOperator
        | AstNotEqualsOperatorNodeRight.BooleanLiteral
        | AstNotEqualsOperatorNodeRight.DynamicVariable
        | AstNotEqualsOperatorNodeRight.EqOperator
        | AstNotEqualsOperatorNodeRight.GtOperator
        | AstNotEqualsOperatorNodeRight.GteOperator
        | AstNotEqualsOperatorNodeRight.Llm
        | AstNotEqualsOperatorNodeRight.LtOperator
        | AstNotEqualsOperatorNodeRight.LteOperator
        | AstNotEqualsOperatorNodeRight.NeqOperator
        | AstNotEqualsOperatorNodeRight.NumberLiteral
        | AstNotEqualsOperatorNodeRight.OrOperator
        | AstNotEqualsOperatorNodeRight.StringLiteral;
