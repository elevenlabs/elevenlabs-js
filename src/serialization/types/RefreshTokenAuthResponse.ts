...
export const RefreshTokenAuthResponse: core.serialization.ObjectSchema<
    serializers.RefreshTokenAuthResponse.Raw,
    ElevenLabs.RefreshTokenAuthResponse
...
export declare namespace RefreshTokenAuthResponse {
