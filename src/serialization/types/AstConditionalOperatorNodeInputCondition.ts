...
export const AstConditionalOperatorNodeInputCondition: core.serialization.Schema<
    serializers.AstConditionalOperatorNodeInputCondition.Raw,
...
export declare namespace AstConditionalOperatorNodeInputCondition {
    export type Raw =
        ...
        | AstConditionalOperatorNodeInputCondition.GteOperator
