...
export const AstEqualsOperatorNodeOutputLeft: core.serialization.Schema<
    serializers.AstEqualsOperatorNodeOutputLeft.Raw,
    ElevenLabs.AstEqualsOperatorNodeOutputLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstEqualsOperatorNodeOutputLeft>({
...
export declare namespace AstEqualsOperatorNodeOutputLeft {
    export type Raw =
        | AstEqualsOperatorNodeOutputLeft.AddOperator
        | AstEqualsOperatorNodeOutputLeft.AndOperator
        | AstEqualsOperatorNodeOutputLeft.BooleanLiteral
        | AstEqualsOperatorNodeOutputLeft.ConditionalOperator
        | AstEqualsOperatorNodeOutputLeft.DivOperator
        | AstEqualsOperatorNodeOutputLeft.DynamicVariable
        | AstEqualsOperatorNodeOutputLeft.EqOperator
        | AstEqualsOperatorNodeOutputLeft.GtOperator
        | AstEqualsOperatorNodeOutputLeft.GteOperator
        | AstEqualsOperatorNodeOutputLeft.Llm
        | AstEqualsOperatorNodeOutputLeft.LtOperator
        | AstEqualsOperatorNodeOutputLeft.LteOperator
        | AstEqualsOperatorNodeOutputLeft.MulOperator
        | AstEqualsOperatorNodeOutputLeft.NeqOperator
        | AstEqualsOperatorNodeOutputLeft.NumberLiteral
        | AstEqualsOperatorNodeOutputLeft.OrOperator
        | AstEqualsOperatorNodeOutputLeft.StringLiteral
        | AstEqualsOperatorNodeOutputLeft.SubOperator;
