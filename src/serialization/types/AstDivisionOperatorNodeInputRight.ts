...
export const AstDivisionOperatorNodeInputRight: core.serialization.Schema<
    serializers.AstDivisionOperatorNodeInputRight.Raw,
    ElevenLabs.AstDivisionOperatorNodeInputRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstDivisionOperatorNodeInputRight>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstDivisionOperatorNodeInputRight {
    export type Raw =
        | AstDivisionOperatorNodeInputRight.AddOperator
        | AstDivisionOperatorNodeInputRight.AndOperator
        | AstDivisionOperatorNodeInputRight.BooleanLiteral
        | AstDivisionOperatorNodeInputRight.ConditionalOperator
        | AstDivisionOperatorNodeInputRight.DivOperator
        | AstDivisionOperatorNodeInputRight.DynamicVariable
        | AstDivisionOperatorNodeInputRight.EqOperator
        | AstDivisionOperatorNodeInputRight.GtOperator
        | AstDivisionOperatorNodeInputRight.GteOperator
        | AstDivisionOperatorNodeInputRight.Llm
        | AstDivisionOperatorNodeInputRight.LtOperator
        | AstDivisionOperatorNodeInputRight.LteOperator
        | AstDivisionOperatorNodeInputRight.MulOperator
        | AstDivisionOperatorNodeInputRight.NeqOperator
        | AstDivisionOperatorNodeInputRight.NumberLiteral
        | AstDivisionOperatorNodeInputRight.OrOperator
        | AstDivisionOperatorNodeInputRight.StringLiteral
        | AstDivisionOperatorNodeInputRight.SubOperator;
