...
export const AstAndOperatorNodeOutputChildrenItem: core.serialization.Schema<
    serializers.AstAndOperatorNodeOutputChildrenItem.Raw,
    ElevenLabs.AstAndOperatorNodeOutputChildrenItem
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstAndOperatorNodeOutputChildrenItem>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstAndOperatorNodeOutputChildrenItem {
    export type Raw =
        | AstAndOperatorNodeOutputChildrenItem.AddOperator
        | AstAndOperatorNodeOutputChildrenItem.AndOperator
        | AstAndOperatorNodeOutputChildrenItem.BooleanLiteral
        | AstAndOperatorNodeOutputChildrenItem.ConditionalOperator
        | AstAndOperatorNodeOutputChildrenItem.DivOperator
        | AstAndOperatorNodeOutputChildrenItem.DynamicVariable
        | AstAndOperatorNodeOutputChildrenItem.EqOperator
        | AstAndOperatorNodeOutputChildrenItem.GtOperator
        | AstAndOperatorNodeOutputChildrenItem.GteOperator
        | AstAndOperatorNodeOutputChildrenItem.Llm
        | AstAndOperatorNodeOutputChildrenItem.LtOperator
        | AstAndOperatorNodeOutputChildrenItem.LteOperator
        | AstAndOperatorNodeOutputChildrenItem.MulOperator
        | AstAndOperatorNodeOutputChildrenItem.NeqOperator
        | AstAndOperatorNodeOutputChildrenItem.NumberLiteral
        | AstAndOperatorNodeOutputChildrenItem.OrOperator
        | AstAndOperatorNodeOutputChildrenItem.StringLiteral
        | AstAndOperatorNodeOutputChildrenItem.SubOperator;
