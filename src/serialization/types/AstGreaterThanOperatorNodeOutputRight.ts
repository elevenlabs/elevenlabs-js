...
export const AstGreaterThanOperatorNodeOutputRight: core.serialization.Schema<
    serializers.AstGreaterThanOperatorNodeOutputRight.Raw,
...
export declare namespace AstGreaterThanOperatorNodeOutputRight {
    export type Raw =
        ...
        | AstGreaterThanOperatorNodeOutputRight.GteOperator
