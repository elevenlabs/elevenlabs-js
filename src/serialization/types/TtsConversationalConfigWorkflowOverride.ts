...
export const TtsConversationalConfigWorkflowOverride: core.serialization.ObjectSchema<
    serializers.TtsConversationalConfigWorkflowOverride.Raw,
    ElevenLabs.TtsConversationalConfigWorkflowOverride
...
export declare namespace TtsConversationalConfigWorkflowOverride {
