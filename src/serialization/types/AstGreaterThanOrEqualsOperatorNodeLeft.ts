...
export const AstGreaterThanOrEqualsOperatorNodeLeft: core.serialization.Schema<
    serializers.AstGreaterThanOrEqualsOperatorNodeLeft.Raw,
    ElevenLabs.AstGreaterThanOrEqualsOperatorNodeLeft
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstGreaterThanOrEqualsOperatorNodeLeft>({
...
export declare namespace AstGreaterThanOrEqualsOperatorNodeLeft {
    export type Raw =
        | AstGreaterThanOrEqualsOperatorNodeLeft.AndOperator
        | AstGreaterThanOrEqualsOperatorNodeLeft.BooleanLiteral
        | AstGreaterThanOrEqualsOperatorNodeLeft.DynamicVariable
        | AstGreaterThanOrEqualsOperatorNodeLeft.EqOperator
        | AstGreaterThanOrEqualsOperatorNodeLeft.GtOperator
        | AstGreaterThanOrEqualsOperatorNodeLeft.GteOperator
        | AstGreaterThanOrEqualsOperatorNodeLeft.Llm
        | AstGreaterThanOrEqualsOperatorNodeLeft.LtOperator
        | AstGreaterThanOrEqualsOperatorNodeLeft.LteOperator
        | AstGreaterThanOrEqualsOperatorNodeLeft.NeqOperator
        | AstGreaterThanOrEqualsOperatorNodeLeft.NumberLiteral
        | AstGreaterThanOrEqualsOperatorNodeLeft.OrOperator
        | AstGreaterThanOrEqualsOperatorNodeLeft.StringLiteral;
