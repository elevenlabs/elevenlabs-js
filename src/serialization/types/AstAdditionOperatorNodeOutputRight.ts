...
export const AstAdditionOperatorNodeOutputRight: core.serialization.Schema<
    serializers.AstAdditionOperatorNodeOutputRight.Raw,
    ElevenLabs.AstAdditionOperatorNodeOutputRight
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.AstAdditionOperatorNodeOutputRight>({
        transform: (value) => value,
        untransform: (value) => value,
    });

export declare namespace AstAdditionOperatorNodeOutputRight {
    export type Raw =
        | AstAdditionOperatorNodeOutputRight.AddOperator
        | AstAdditionOperatorNodeOutputRight.AndOperator
        | AstAdditionOperatorNodeOutputRight.BooleanLiteral
        | AstAdditionOperatorNodeOutputRight.ConditionalOperator
        | AstAdditionOperatorNodeOutputRight.DivOperator
        | AstAdditionOperatorNodeOutputRight.DynamicVariable
        | AstAdditionOperatorNodeOutputRight.EqOperator
        | AstAdditionOperatorNodeOutputRight.GtOperator
        | AstAdditionOperatorNodeOutputRight.GteOperator
        | AstAdditionOperatorNodeOutputRight.Llm
        | AstAdditionOperatorNodeOutputRight.LtOperator
        | AstAdditionOperatorNodeOutputRight.LteOperator
        | AstAdditionOperatorNodeOutputRight.MulOperator
        | AstAdditionOperatorNodeOutputRight.NeqOperator
        | AstAdditionOperatorNodeOutputRight.NumberLiteral
        | AstAdditionOperatorNodeOutputRight.OrOperator
        | AstAdditionOperatorNodeOutputRight.StringLiteral
        | AstAdditionOperatorNodeOutputRight.SubOperator;
