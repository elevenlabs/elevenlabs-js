...
export const InitializeConnectionMultiVoiceSettings: core.serialization.ObjectSchema<
    serializers.InitializeConnectionMultiVoiceSettings.Raw,
    ElevenLabs.InitializeConnectionMultiVoiceSettings
...
export declare namespace InitializeConnectionMultiVoiceSettings {
