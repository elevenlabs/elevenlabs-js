...
import { AstBooleanNodeInput } from "./AstBooleanNodeInput.js";
import { AstDynamicVariableNodeInput } from "./AstDynamicVariableNodeInput.js";
import { AstNodeInputLlm } from "./AstNodeInputLlm.js";
import { AstNullNodeInput } from "./AstNullNodeInput.js";
import { AstNumberNodeInput } from "./AstNumberNodeInput.js";
import { AstStringNodeInput } from "./AstStringNodeInput.js";

export const AstNodeInput: core.serialization.Schema<serializers.AstNodeInput.Raw, ElevenLabs.AstNodeInput> =
    core.serialization
        .union("type", {
        ...
        .transform<ElevenLabs.AstNodeInput>({
...
export declare namespace AstNodeInput {
    export type Raw =
        | AstNodeInput.AddOperator
        | AstNodeInput.AndOperator
        | AstNodeInput.BooleanLiteral
        | AstNodeInput.ConditionalOperator
        | AstNodeInput.DivOperator
        | AstNodeInput.DynamicVariable
        | AstNodeInput.EqOperator
        | AstNodeInput.GtOperator
        | AstNodeInput.GteOperator
        | AstNodeInput.Llm
        | AstNodeInput.LtOperator
