...
export const DocumentRefreshResponse: core.serialization.Schema<
    serializers.conversationalAi.knowledgeBase.DocumentRefreshResponse.Raw,
    ElevenLabs.conversationalAi.knowledgeBase.DocumentRefreshResponse
> = core.serialization
    .union("type", {
    ...
    .transform<ElevenLabs.conversationalAi.knowledgeBase.DocumentRefreshResponse>({
...
export declare namespace DocumentRefreshResponse {
    export type Raw =
        | DocumentRefreshResponse.Url
        | DocumentRefreshResponse.File
        | DocumentRefreshResponse.Text
