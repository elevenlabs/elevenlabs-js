...
export const DubbingSegmentUpdateRequest: core.serialization.Schema<
    serializers.dubbing.project.DubbingSegmentUpdateRequest.Raw,
    ElevenLabs.dubbing.project.DubbingSegmentUpdateRequest
