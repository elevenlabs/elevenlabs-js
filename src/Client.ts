...
import { TextToSoundEffect } from "./api/resources/textToSoundEffect/client/Client";
...
export class ElevenLabsClient {
    ...
    protected _textToSoundEffect: TextToSoundEffect | undefined;

    public get textToSoundEffect(): TextToSoundEffect {
        return (this._textToSoundEffect ??= new TextToSoundEffect(this._options));
    }
