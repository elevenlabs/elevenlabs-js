...
describe("TriageTicketsClient", () => {
    test("list", async () => {
        ...
        const response = await client.agents.triageTickets.list("agent_id", {
            pageSize: 1,
    ...
    test("create_manual", async () => {
        ...
        const response = await client.agents.triageTickets.createManual("agent_id", {
            qaComment: "qa_comment",
        });
        expect(response).toEqual({
            agentqaTicketId: "agentqa_ticket_id",
    ...
    test("list_for_workspace", async () => {
        ...
        const response = await client.agents.triageTickets.listForWorkspace({
            pageSize: 1,
            status: "open",
            assigneeUserId: "assignee_user_id",
            cursor: "cursor",
    ...
    test("create", async () => {
        ...
        const response = await client.agents.triageTickets.create({
            conversationId: "conversation_id",
        });
        expect(response).toEqual({
            agentqaTicketId: "agentqa_ticket_id",
    ...
    test("list_assignable_users", async () => {
        ...
        const response = await client.agents.triageTickets.listAssignableUsers("agent_id");
        expect(response).toEqual([
            {
                userId: "user_id",
                email: "email",
    ...
    test("get", async () => {
        ...
        const response = await client.agents.triageTickets.get("agentqa_ticket_id");
        expect(response).toEqual({
            agentqaTicketId: "agentqa_ticket_id",
            workspaceId: "workspace_id",
            ownerUserId: "owner_user_id",
    ...
    test("delete", async () => {
        ...
        const response = await client.agents.triageTickets.delete("agentqa_ticket_id");
    ...
    test("update", async () => {
        ...
        const response = await client.agents.triageTickets.update("agentqa_ticket_id");
        expect(response).toEqual({
            agentqaTicketId: "agentqa_ticket_id",
            workspaceId: "workspace_id",
            ownerUserId: "owner_user_id",
    ...
    test("add_comment", async () => {
        ...
        const response = await client.agents.triageTickets.addComment("agentqa_ticket_id", {
            comment: "comment",
        });
        expect(response).toEqual({
            agentqaTicketId: "agentqa_ticket_id",
    ...
    test("add_turn_comment", async () => {
        ...
        const response = await client.agents.triageTickets.addTurnComment("agentqa_ticket_id", {
            turnIndex: 1,
            comment: "comment",
        });
        expect(response).toEqual({
