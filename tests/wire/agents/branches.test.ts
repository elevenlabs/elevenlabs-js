...
describe("BranchesClient", () => {
    test("list", async () => {
        ...
        const response = await client.agents.branches.list("agent_3701k3ttaq12ewp8b7qv5rfyszkz", {
    ...
    test("create", async () => {
        ...
        const response = await client.agents.branches.create("agent_3701k3ttaq12ewp8b7qv5rfyszkz", {
    ...
    test("get", async () => {
        ...
        const response = await client.agents.branches.get(
    ...
    test("update", async () => {
        ...
        const response = await client.agents.branches.update(
            "agent_3701k3ttaq12ewp8b7qv5rfyszkz",
            "agtbranch_0901k4aafjxxfxt93gd841r7tv5t",
        );
        expect(response).toEqual({
    ...
    test("preview_merge", async () => {
        ...
        server
            .mockEndpoint()
            .get(
                "/v1/convai/agents/agent_3701k3ttaq12ewp8b7qv5rfyszkz/branches/agtbrch_8901k4t9z5defmb8vh3e9361y7nj/merge-preview",
            )
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
        ...
        const response = await client.agents.branches.previewMerge(
            "agent_3701k3ttaq12ewp8b7qv5rfyszkz",
                    ...
                    criteria: [
                        {
                            id: "criterion_binary_001",
                            name: "Issue resolved",
                            conversationGoalPrompt: "Determine whether the agent fully resolved the user's issue.",
    ...
    test("merge", async () => {
        ...
        const response = await client.agents.branches.merge(
            "agent_3701k3ttaq12ewp8b7qv5rfyszkz",
            "agtbrch_8901k4t9z5defmb8vh3e9361y7nj",
            {
                targetBranchId: "agtbrch_8901k4t9z5defmb8vh3e9361y7nj",
    ...
    test("preview_rebase", async () => {
        ...
        server
            .mockEndpoint()
            .get(
                "/v1/convai/agents/agent_3701k3ttaq12ewp8b7qv5rfyszkz/branches/agtbrch_8901k4t9z5defmb8vh3e9361y7nj/rebase-preview",
            )
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
        ...
        const response = await client.agents.branches.previewRebase(
            "agent_3701k3ttaq12ewp8b7qv5rfyszkz",
            "agtbrch_8901k4t9z5defmb8vh3e9361y7nj",
        );
        expect(response).toEqual({
    ...
    test("rebase", async () => {
        ...
        const response = await client.agents.branches.rebase(
            "agent_3701k3ttaq12ewp8b7qv5rfyszkz",
            "agtbrch_8901k4t9z5defmb8vh3e9361y7nj",
        );
        expect(response).toEqual({
