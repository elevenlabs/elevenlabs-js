...
describe("DraftsClient", () => {
    test("create", async () => {
            ...
            workflow: {
                edges: {
                    entry_to_tool_a: {
                        source: "entry_node",
                        target: "tool_node_a",
                        forward_condition: { type: "expression", expression: { type: "and_operator", children: [] } },
                    },
                    start_to_entry: {
                        source: "start_node",
                        target: "entry_node",
        ...
        const response = await client.agents.drafts.create("agent_3701k3ttaq12ewp8b7qv5rfyszkz", {
    ...
    test("delete", async () => {
        ...
        const response = await client.agents.drafts.delete("agent_3701k3ttaq12ewp8b7qv5rfyszkz", {
            branchId: "agtbrch_8901k4t9z5defmb8vh3e9361y7nj",
        });
        expect(response).toEqual({
            key: "value",
