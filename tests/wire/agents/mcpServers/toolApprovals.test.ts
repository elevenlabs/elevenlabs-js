...
describe("ToolApprovalsClient", () => {
    test("create", async () => {
        ...
        const response = await client.agents.mcpServers.toolApprovals.create("mcp_server_id", {
            toolName: "tool_name",
    ...
    test("delete", async () => {
        ...
        const response = await client.agents.mcpServers.toolApprovals.delete("mcp_server_id", "tool_name");
        expect(response).toEqual({
            id: "id",
            config: {
                approvalPolicy: "auto_approve_all",
