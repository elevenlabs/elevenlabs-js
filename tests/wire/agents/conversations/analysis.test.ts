...
describe("AnalysisClient", () => {
    test("run", async () => {
        ...
        const response = await client.agents.conversations.analysis.run("conversation_id");
    ...
    test("runEvaluation", async () => {
        ...
        const response = await client.agents.conversations.analysis.runEvaluation("conversation_id", {
