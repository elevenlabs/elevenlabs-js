...
describe("BatchCallsClient", () => {
    test("create", async () => {
        ...
        const response = await client.agents.batchCalls.create({
            callName: "call_name",
            agentId: "agent_id",
            recipients: [{}],
        });
    ...
    test("list", async () => {
        ...
        const response = await client.agents.batchCalls.list({
            limit: 1,
            lastDoc: "last_doc",
            agentId: "agent_id",
        });
    ...
    test("get", async () => {
        ...
        const response = await client.agents.batchCalls.get("batch_id");
        expect(response).toEqual({
            id: "id",
            phoneNumberId: "phone_number_id",
            phoneProvider: "twilio",
    ...
    test("delete", async () => {
        ...
        const response = await client.agents.batchCalls.delete("batch_id");
    ...
    test("cancel", async () => {
        ...
        const response = await client.agents.batchCalls.cancel("batch_id");
        expect(response).toEqual({
            id: "id",
            phoneNumberId: "phone_number_id",
            phoneProvider: "twilio",
    ...
    test("retry", async () => {
        ...
        const response = await client.agents.batchCalls.retry("batch_id");
        expect(response).toEqual({
            id: "id",
            phoneNumberId: "phone_number_id",
            phoneProvider: "twilio",
