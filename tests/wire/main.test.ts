...
describe("ElevenLabsClient", () => {
    test("create_agent_response_test_route", async () => {
        ...
        const response = await client.createAgentResponseTestRoute({
            chatHistory: [
                {
                    role: "user",
                    timeInCallSecs: 1,
    ...
    test("get_agent_response_test_route", async () => {
        const server = mockServerPool.createServer();
        const client = new ElevenLabsClient({ apiKey: "test", environment: server.baseUrl });
        ...
        const response = await client.getAgentResponseTestRoute("TeaqRRdTcIfIu2i7BYfT");
        expect(response).toEqual({
            chatHistory: [
                {
                    role: "user",
    ...
    test("update_agent_response_test_route", async () => {
        const server = mockServerPool.createServer();
        const client = new ElevenLabsClient({ apiKey: "test", environment: server.baseUrl });
        const rawRequestBody = {
            chat_history: [{ role: "user", time_in_call_secs: 1 }],
        ...
        const response = await client.updateAgentResponseTestRoute("TeaqRRdTcIfIu2i7BYfT", {
            chatHistory: [
                {
                    role: "user",
                    timeInCallSecs: 1,
    ...
    test("delete_chat_response_test_route", async () => {
        const server = mockServerPool.createServer();
        const client = new ElevenLabsClient({ apiKey: "test", environment: server.baseUrl });
        ...
        const response = await client.deleteChatResponseTestRoute("TeaqRRdTcIfIu2i7BYfT");
        expect(response).toEqual({
            key: "value",
        });
    });

    test("get_agent_response_tests_summaries_route", async () => {
        const server = mockServerPool.createServer();
        const client = new ElevenLabsClient({ apiKey: "test", environment: server.baseUrl });
        ...
        const response = await client.getAgentResponseTestsSummariesRoute({
    ...
    test("list_chat_response_tests_route", async () => {
        const server = mockServerPool.createServer();
        const client = new ElevenLabsClient({ apiKey: "test", environment: server.baseUrl });
        ...
        const response = await client.listChatResponseTestsRoute();
        expect(response).toEqual({
            tests: [
                {
                    id: "id",
    ...
    test("run_agent_test_suite_route", async () => {
        const server = mockServerPool.createServer();
        const client = new ElevenLabsClient({ apiKey: "test", environment: server.baseUrl });
        ...
        const response = await client.runAgentTestSuiteRoute("21m00Tcm4TlvDq8ikWAM", {
            tests: [
                {
                    testId: "test_id",
                },
    ...
    test("get_test_invocation_route", async () => {
        const server = mockServerPool.createServer();
        const client = new ElevenLabsClient({ apiKey: "test", environment: server.baseUrl });
        ...
        const response = await client.getTestInvocationRoute("test_invocation_id");
        expect(response).toEqual({
            id: "id",
            createdAt: 1,
            testRuns: [
    ...
    test("resubmit_tests_route", async () => {
        const server = mockServerPool.createServer();
        const client = new ElevenLabsClient({ apiKey: "test", environment: server.baseUrl });
        ...
        const response = await client.resubmitTestsRoute("test_invocation_id", {
