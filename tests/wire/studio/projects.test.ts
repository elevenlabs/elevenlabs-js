    ...
    test("get", async () => {
        ...
        const rawResponseBody = {
            ...
            caption_style: {
                ...
                text_shadow: { enabled: true, color: "color", opacity: 1.1, blur: 1.1, offset_x: 1.1, offset_y: 1.1 },
                text_outline: { enabled: true, color: "color", opacity: 1.1, width: 1.1 },
            ...
            publishing_read: {
                ...
                word_count: 1,
                char_count: 1,
                chapters: [{ chapter_name: "chapter_name", word_count: 1, char_count: 1, starting_char_offset: 1 }],
                title: "title",
                author: "author",
                ...
                copyright: "copyright",
                subtitle: "subtitle",
                distribution_territories: ["distribution_territories"],
                edition: "edition",
                contributors: [{ name: "name", role: "role" }],
                payout_type: "none",
                list_price: 1.1,
                currency: "usd",
        ...
        expect(response).toEqual({
            ...
            captionStyle: {
                ...
                wordHighlightsBorderRadius: 1.1,
                wordHighlightsBlur: 1.1,
                sectionAnimation: {
                    enterType: "none",
                    exitType: "none",
                },
            ...
            publishingRead: {
                ...
                originalFileType: "original_file_type",
                targetAudience: "children",
                matureContent: true,
                safesearchAdult: true,
                origin: "origin",
                ...
                copyright: "copyright",
                subtitle: "subtitle",
                distributionTerritories: ["distribution_territories"],
                edition: "edition",
                contributors: [
                    {
                        name: "name",
                ...
                listPrice: 1.1,
                currency: "usd",
                originalAudioProjectExportId: "original_audio_project_export_id",
                originalAudioDocumentId: "original_audio_document_id",
                seriesId: "series_id",
                volume: 1,
                publishedAtUnix: 1,
                readSlug: "read_slug",
