...
describe("AgentsClient", () => {
    ...
    test("get", async () => {
        ...
        const response = await client.agents.get("agent_3701k3ttaq12ewp8b7qv5rfyszkz", {
    ...
    test("delete", async () => {
        ...
        const response = await client.agents.delete("agent_3701k3ttaq12ewp8b7qv5rfyszkz");
    ...
    test("update", async () => {
        ...
        const response = await client.agents.update("agent_3701k3ttaq12ewp8b7qv5rfyszkz", {
    ...
    test("duplicate", async () => {
        ...
        const response = await client.agents.duplicate("agent_3701k3ttaq12ewp8b7qv5rfyszkz");
        expect(response).toEqual({
            agentId: "J3Pbu5gP6NNKBscdCdwB",
        });
    });
    ...
    test("run_tests", async () => {
        ...
        const response = await client.agents.runTests("agent_3701k3ttaq12ewp8b7qv5rfyszkz", {
            tests: [
                {
                    testId: "test_id",
                },
    ...
    test("rag_index_overview", async () => {
        ...
        const response = await client.agents.ragIndexOverview();
        expect(response).toEqual({
            totalUsedBytes: 1,
            totalMaxBytes: 1,
            models: [
    ...
    test("get_document_rag_indexes", async () => {
        ...
        const response = await client.agents.getDocumentRagIndexes("21m00Tcm4TlvDq8ikWAM");
        expect(response).toEqual({
            indexes: [
                {
                    id: "id",
    ...
    test("delete_document_rag_index", async () => {
        ...
        const response = await client.agents.deleteDocumentRagIndex("21m00Tcm4TlvDq8ikWAM", "21m00Tcm4TlvDq8ikWAM");
        expect(response).toEqual({
            id: "id",
            model: "e5_mistral_7b_instruct",
            status: "new",
